...
--
-- Host: 127.0.0.1
-- Creato il: Gen 12, 2023 alle 11:34
...
INSERT INTO `destination` (`id`, `name`, `continent`, `state`, `description`) VALUES
...
(16, './assets/Africa/capeTown-southAfrica/activities/safari-acquila/images/reserve3.webp', 'Una leonessa e il suo cucciolo giocano affettuosamente.', 0, 3),
(17, './assets/Africa/capeTown-southAfrica/activities/safari-acquila/images/reserve4.webp', 'Quattro ghepardi divorano in modo famelico una gazzella.', 0, 3),
(18, './assets/Africa/capeTown-southAfrica/activities/safari-acquila/images/reserve5.webp', 'Macro di un elefante che con la proboscite di porta alla bocca un ramo.', 0, 3),
...
(28, './assets/Africa/capeTown-southAfrica/activities/shark-dive/images/cover.webp', 'Squalo bianco avvistato dalla gabbia sommersa.', 1, 5),
(29, './assets/Africa/capeTown-southAfrica/activities/shark-dive/images/shark1.webp', 'Foto subacquea di uno squalo bianco.', 0, 5),
(30, './assets/Africa/capeTown-southAfrica/activities/shark-dive/images/shark2.webp', 'Squalo bianco esce dall\'acqua con le fauci spalancate.', 0, 5),
...
(277, './assets/Europa/Ibiza/activities/Cala d\'Hort/images/cala_1.webp', 'Spiaggia di <span lang=\"es\">Cala d\'Hort</span>. Sulla sinistra vi è la spiaggia sabbiosa con scogli solo sull\'estremità. Il mare è cristallino con qualche barca a vela parcheggiata oltre alle boe.', 0, 61),
(278, './assets/Europa/Ibiza/activities/Cala d\'Hort/images/cala_2.webp', 'Vista delle due isole che fronteggiano <span lang=\"es\">Cala d\'Hort: \'Es Vedra</span> e <span lang=\"es\">Es Vedranell\'</span>, in una giornata di sole. Il mare cristallino con una barca a vela da sola che solca il mare. Si vede pure una piccola parte di spiaggia con degli ombrelloni e lettini.', 0, 61),
...
(281, './assets/Europa/Ibiza/activities/Cova de Can Marçà/images/cova_de_can_1.webp', 'Grotta di <span lang=\"es\">Can Marçà</span> con il soffitto centinaia di stalattiti e qualche stalagmite che parte dal suolo. La luce arancione è soffusa che crea una sensazione cupa alla vista.', 0, 62),
...
(284, './assets/Europa/Ibiza/activities/Dalt Vila/images/cover.webp', 'Città vecchia di <span lang=\"es\">Ibiza, Dalt Vila</span>, situata su una collina di fronte al mare. Nella parte bassa della città le case sono tutte dipinte di bianco con in cima alla collina il castello che domina la città dall\'alto in una giornata soleggiata.', 1, 63),
(285, './assets/Europa/Ibiza/activities/Dalt Vila/images/dalt_vila_1.webp', 'Vista di tutta la città vecchia di <span lang=\"es\">Ibiza Dalt Vila</span>, situata in una collina che fronteggia il mare. In cima alla collina il castello che occupa gran parte di essa, sovrasta dall\'alto le abitazioni cittadine. Il mare è di un blu acceso in una giornata di sole.', 0, 63),
...
(287, './assets/Europa/Ibiza/activities/Dalt Vila/images/dalt_vila_3.webp', '<span lang=\"es\">Dalt Vila</span> illuminata dalle luci notturne, rivela le proprie abitazioni colorate di un giallo ocra da queste luci con il castello illuminato di bianco che sovrasta dall\'alto la città.', 0, 63),
(288, './assets/Europa/Ibiza/activities/Necropoli di Puig des Molins/images/cover.webp', 'Dama di <span lang=\"es\">Ibiza</span> e altre 3 statue puniche della necropoli. ', 1, 64),
...
(379, './assets/NordAmerica/losAngeles-california/activities/madame-tussauds/images/cover.webp', 'Logo del Madame Tussauds di <span lang=\"en\">Hollywood</span>.', 1, 84),
...
(1, './assets/Africa/capeTown-southAfrica/airline/images/kl-logo-small-2022.svg', 'Scritta della KLM Royal Dutch Airlines, la scritta KLM è in grassetto maiuscolo, sopra il logo di una corona stilizzata.', 1, '<span lang=\"en\">KLM Royal Dutch Airlines</span>'),
...
(4, './assets/Africa/windhoek-namibia/airline/images/lufthansa-logo.svg', 'Logo Lufthansa, un uccello all\'interno di un cerchio.', 1, 'Lufthansa'),
...
(8, './assets/Africa/mwanza-tanzania/images/cover.webp', 'Foto di <span lang=\"af\">Mwanza</span> vista da una delle due sponde del golfo. La città appare immersa nella natura e presenta una conformazione collinare.', 1, 2),
(9, './assets/Africa/mwanza-tanzania/images/lake-victoria1.webp', 'Spiaggia di <span lang=\"af\">Mwanza</span> sul lago Vittoria, l\'acqua è un po\'torbida. Sono presenti alcuni alberi sulla spiaggia che creano zone d\'ombra.', 0, 2),
...
(12, './assets/Africa/mwanza-tanzania/images/mwanza2.webp', 'Contrasto tra i palazzi di <span lang=\"af\">Mwanza</span> e la natura che circonda e avvolge la città.', 0, 2),
...
(24, './assets/Africa/windhoek-namibia/images/windhoek3.webp', 'La famosa chiesa di Cristo di <span lang=\"en\">Windhoek</span>.', 0, 4),
...
(103, './assets/NordAmerica/losAngeles-california/images/cover.webp', 'Primo piano della caratteristica scritta hollywood sulle colline di <span lang=\"en\">Los Angeles</span>.', 1, 18),
(104, './assets/NordAmerica/losAngeles-california/images/losAngeles1.webp', 'Vista da distante della caratteristica scritta hollywood sulle colline di <span lang=\"en\">Los Angeles</span>.', 0, 18),
...
(106, './assets/NordAmerica/losAngeles-california/images/losAngeles3.webp', 'Alcuni grattacieli di <span lang=\"en\">Los Angeles</span>.', 0, 18),
...
(32, './assets/Africa/windhoek-namibia/hotel/images/reception.webp', '<span lang=\"en\">Reception</span> ordinata con una caraffa di succo e alcuni bicchieri e dei fiori alle estremità del bancone.', 0, 4),
...
(96, './assets/Europa/Ibiza/hotel/images/external.webp', 'Salotto esterno coperto con un apertura vista mare. In questo salotto con pavimento di <span lang=\"fr\">parquet</span> vi è un tavolino di legno scuro con una sedia e un divanetto con un piccolo tavolo in legno chiaro. Vi è uno sdraio vista mare raggiungibile percorrendo 3 scalini. ', 0, 14),
...
(119, './assets/NordAmerica/losAngeles-california/hotel/images/reception.webp', '<span lang=\"en\">Reception</span> dell\'Hotel, design lussuoso con piante ornamentali alle estremità ed un alto vaso nel mezzo.', 0, 18),
