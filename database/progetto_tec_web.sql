...
--
-- Host: 127.0.0.1
-- Creato il: Gen 31, 2023 alle 12:09
...
INSERT INTO `image_activity` (`id`, `path`, `alt`, `activity`, `is_cover`) VALUES
(1, './assets/Africa/capeTown-southAfrica/activities/bike-tour/images/cover.webp', 'Muontain bike posizionata davati al cartello di legno in cui si legge \'Cape of Good Hope the most so', 1, 1),
(2, './assets/Africa/capeTown-southAfrica/activities/bike-tour/images/bike1.webp', 'Foto di 3 amici in una sosta lungo il tragitto del bike tour. La strada è asfaltata e in questo trat', 1, 0),
(3, './assets/Africa/capeTown-southAfrica/activities/bike-tour/images/bike2.webp', 'Primo piano di una bicicletta in sosta su un spiazzo d\'erba, con mare e colline sullo sfondo.', 1, 0),
(4, './assets/Africa/capeTown-southAfrica/activities/bike-tour/images/bike3.webp', 'Muontain bike parcheggiata sulla stradina di asfalto, sullo sfondo si nota la spiaggia bagnata dal m', 1, 0),
(5, './assets/Africa/capeTown-southAfrica/activities/city-tour/images/cover.webp', 'Foto dall\'esterno di una cabina della funivia che porta i turisti in cima alla montagna. Sullo sfond', 2, 1),
(6, './assets/Africa/capeTown-southAfrica/activities/city-tour/images/tour1.webp', 'Viale asfaltato in cui alcuni turisti passeggiano stranquillamente guardando le numerose casette col', 2, 0),
(7, './assets/Africa/capeTown-southAfrica/activities/city-tour/images/tour2.webp', 'Visuale dalla cima della montagna del panorama circostante, si vede una montagna più bassa con la ci', 2, 0),
(8, './assets/Africa/capeTown-southAfrica/activities/city-tour/images/tour3.webp', 'Cabina di una funivia trasporta i turisti sulla vetta, la montagna è molto ripida e rocciosa.', 2, 0),
(9, './assets/Africa/capeTown-southAfrica/activities/city-tour/images/tour4.webp', 'Foto alla luce del tramonto del paesaggio dall\'alto, si osservano due montagne, la prima in primo pi', 2, 0),
(10, './assets/Africa/capeTown-southAfrica/activities/city-tour/images/tour5.webp', 'Spiaggia di sabbia bianca affollata di pinguini, il mare limpido e calmo bagna la costa.', 2, 0),
(11, './assets/Africa/capeTown-southAfrica/activities/city-tour/images/tour6.webp', 'Primo piano di due pinguini africani.', 2, 0),
(12, './assets/Africa/capeTown-southAfrica/activities/city-tour/images/tour7.webp', 'Una numerosa colonia di pinguini riposa su un\'ampia spiaggia di sabbia bianca.', 2, 0),
(13, './assets/Africa/capeTown-southAfrica/activities/safari-aquila/images/cover.webp', 'Foto macro del muso di un leopardo steso sull\'erba con gli occhi aperti vigili.', 3, 1),
(14, './assets/Africa/capeTown-southAfrica/activities/safari-aquila/images/reserve1.webp', 'Maestoso leone in piedi in mezzo a un prato erboso.', 3, 0),
(15, './assets/Africa/capeTown-southAfrica/activities/safari-aquila/images/reserve2.webp', 'Cucciolo di elefante cammiina nella natura, alberi bassi e arbusti lo circondano.', 3, 0),
(16, './assets/Africa/capeTown-southAfrica/activities/safari-aquila/images/reserve3.webp', 'Una leonessa e il suo cucciolo giocano affettuosamente.', 3, 0),
(17, './assets/Africa/capeTown-southAfrica/activities/safari-aquila/images/reserve4.webp', 'Quattro ghepardi divorano in modo famelico una gazzella.', 3, 0),
(18, './assets/Africa/capeTown-southAfrica/activities/safari-aquila/images/reserve5.webp', 'Macro di un elefante che con la proboscite di porta alla bocca un ramo.', 3, 0),
(19, './assets/Africa/capeTown-southAfrica/activities/safari-aquila/images/reserve6.webp', 'Un cucciolo di elefante cammina tra gli alberi seguito da un altro elefante poco più grande.', 3, 0),
(20, './assets/Africa/capeTown-southAfrica/activities/safari-aquila/images/reserve7.webp', 'Il fuoristrada tursitico si avvicina a un esemplare di Eland.', 3, 0),
(21, './assets/Africa/capeTown-southAfrica/activities/safari-aquila/images/reserve8.webp', 'Punto di ristoro del safari, locale a forma di capanna. L\'interno illuminato da ampie vetrate ospita', 3, 0),
(22, './assets/Africa/capeTown-southAfrica/activities/sea-tour/images/cover.webp', 'Due foche appena uscita dall\'acqua si godono il sole stese sulle rocce.', 4, 1),
(23, './assets/Africa/capeTown-southAfrica/activities/sea-tour/images/sea1.webp', 'Un turista fotografa una balenottera riaffiorata accanto all\'imbarcazione.', 4, 0),
(24, './assets/Africa/capeTown-southAfrica/activities/sea-tour/images/sea2.webp', 'Una foca salta fuori dall\'acqua a pancia in su.', 4, 0),
(25, './assets/Africa/capeTown-southAfrica/activities/sea-tour/images/sea3.webp', 'Foca salta fuori dall\'acqua giocosamente.', 4, 0),
(26, './assets/Africa/capeTown-southAfrica/activities/sea-tour/images/sea4.webp', 'Una numerosa colonia di foche si trova in riva al mare, alcune riposano sulla spiaggia altre nuotano', 4, 0),
(27, './assets/Africa/capeTown-southAfrica/activities/sea-tour/images/sea5.webp', 'Uno squalo addenta la corda di una rete.', 4, 0),
(28, './assets/Africa/capeTown-southAfrica/activities/shark-dive/images/cover.webp', 'Squalo bianco avvistato dalla gabbia sommersa.', 5, 0),
(29, './assets/Africa/capeTown-southAfrica/activities/shark-dive/images/shark1.webp', 'Foto subacquea di uno squalo bianco.', 5, 0),
(30, './assets/Africa/capeTown-southAfrica/activities/shark-dive/images/shark2.webp', 'Squalo bianco esce dall\'acqua con le fauci spalancate.', 5, 1),
(31, './assets/Africa/capeTown-southAfrica/activities/shark-dive/images/shark3.webp', 'Sede delle immersioni.', 5, 0),
(32, './assets/Africa/capeTown-southAfrica/activities/shark-dive/images/shark4.webp', 'Interno del locale ristoro con tavole con panche, cucina e bagni.', 5, 0),
(33, './assets/Africa/capeTown-southAfrica/activities/shark-dive/images/shark5.webp', 'Interno dei bagni con corridi separati per wc e docce.', 5, 0),
(34, './assets/Africa/capeTown-southAfrica/activities/steam-train/images/cover.webp', 'Il treno a vapore attraversa la pianura.', 6, 1),
(35, './assets/Africa/capeTown-southAfrica/activities/steam-train/images/steam1.webp', 'Il paesaggio caratterizzato da bassi arbusti è attraversato dai binari del treno a vapore di cui si ', 6, 0),
(36, './assets/Africa/capeTown-southAfrica/activities/steam-train/images/steam2.webp', 'Mercato ferroviario di Elgin, nella zona mostrata sono presenti numerosi tavoli affollati da turisti', 6, 0),
(37, './assets/Africa/capeTown-southAfrica/activities/steam-train/images/steam3.webp', 'Il treno attraversa Elgin Valley e i passeggeri a bordo si godono la vistuale del panorama circostan', 6, 0),
(38, './assets/Africa/capeTown-southAfrica/activities/wine-tour/images/cover.webp', 'Rigogliosi vigneti nei dintorni di Stellenbsch visti dall\'alto, nello sfondo le montagne.', 7, 1),
(39, './assets/Africa/capeTown-southAfrica/activities/wine-tour/images/wine1.webp', 'Vigneto di Stellenbosch circondato da alberi, le imponenti montagne di Simonsberg sullo sfondo.', 7, 0),
(40, './assets/Africa/capeTown-southAfrica/activities/wine-tour/images/wine2.webp', 'Interno del locale degustazione della cantina, è presente un tavolo con diverse bottiglie di vino ro', 7, 0),
(41, './assets/Africa/capeTown-southAfrica/activities/wine-tour/images/wine3.webp', 'Succosi grappoli di uva nera maturano sui vigneti.', 7, 0),
(42, './assets/Africa/capeTown-southAfrica/activities/wine-tour/images/wine4.webp', 'Un somelier versa del vino bianco su un calice per la degustazione.', 7, 0),
(43, './assets/Africa/mwanza-tanzania/activities/cratere/images/cover.webp', 'Savana interna al cratere di Ngorongoro con un branco di gnu al pascolo. Si vedono le nuvole risalir', 8, 1),
(44, './assets/Africa/mwanza-tanzania/activities/cratere/images/cratere1.webp', 'Zebra che si nutre del latte materno nella savana.', 8, 0),
(45, './assets/Africa/mwanza-tanzania/activities/cratere/images/cratere2.webp', '3 ippopotami appagati che riposano nella savana', 8, 0),
(46, './assets/Africa/mwanza-tanzania/activities/cratere/images/cratere3.webp', 'Stormo di avvoltoi di Ruppel a terra probabilmente intenti a saccheggiare gli avanzi della preda del', 8, 0),
(47, './assets/Africa/mwanza-tanzania/activities/cratere/images/cratere4.webp', 'Un elefante africano con la pelle ricoperta di fango ormai secco.', 8, 0),
(48, './assets/Africa/mwanza-tanzania/activities/cratere/images/cratere5.webp', 'Primo piano di un giovane leone.', 8, 0),
(49, './assets/Africa/mwanza-tanzania/activities/grande-migrazione/images/cover.webp', 'Un gruppo di 5 zebre nella savana.', 9, 1),
(50, './assets/Africa/mwanza-tanzania/activities/grande-migrazione/images/migrazione1.webp', '3 ippopotami che camminano nella savana.', 9, 0),
(51, './assets/Africa/mwanza-tanzania/activities/grande-migrazione/images/migrazione2.webp', 'Uno struzzo nella savana.', 9, 0),
(52, './assets/Africa/mwanza-tanzania/activities/grande-migrazione/images/migrazione3.webp', 'Un gruppo di gnu che si riposa nella savana.', 9, 0),
(53, './assets/Africa/mwanza-tanzania/activities/isola-rubondo/images/cover.webp', 'Uno scimpanzé tra le foglie che osserva sorpreso il fotografo.', 10, 1),
(54, './assets/Africa/mwanza-tanzania/activities/isola-rubondo/images/rubondo1.webp', 'Un gruppo di elefanti in una zona paludosa della giungla.', 10, 0),
(55, './assets/Africa/mwanza-tanzania/activities/isola-rubondo/images/rubondo2.webp', 'Primo piano di una scimmia che si strofina del filo tra i denti.', 10, 0),
(56, './assets/Africa/mwanza-tanzania/activities/isola-rubondo/images/rubondo3.webp', 'Un turista che dalla sua jeep fotografa un ippopotamo nella savana.', 10, 0),
(57, './assets/Africa/mwanza-tanzania/activities/serengeti/images/cover.webp', 'Un ghepardo che sbadiglia tra la folta erba della savana.', 11, 1),
(58, './assets/Africa/mwanza-tanzania/activities/serengeti/images/serengeti1.webp', 'Una jeep che attraversa una strada sterrata con sulla sinistra una giraffa.', 11, 0),
(59, './assets/Africa/mwanza-tanzania/activities/serengeti/images/serengeti2.webp', '3 jeep che passano in mezzo ad un grande branco di gnu intenti a pascolare nella savana.', 11, 0),
(60, './assets/Africa/mwanza-tanzania/activities/serengeti/images/serengeti3.webp', '3 iene nella savana, a giudicare dalla postura sembrano essere state attirate da qualcosa, forse una', 11, 0),
(61, './assets/Africa/sharmElSheikh-egitto/activities/dolphins/images/cover.webp', 'Un delfino con una palla tra i denti e una tra le pinne che fuoriesce parzialmente dall\'acqua.', 12, 1),
(62, './assets/Africa/sharmElSheikh-egitto/activities/dolphins/images/dolphin1.webp', 'Una bambina  in acqua con giubbotto salvagente che gioca con 4 delfini.', 12, 0),
(63, './assets/Africa/sharmElSheikh-egitto/activities/dolphins/images/dolphin2.webp', '4 bambini in acqua con giubbotto salvagente che giocano con 2 delfini.', 12, 0),
(64, './assets/Africa/sharmElSheikh-egitto/activities/dolphins/images/dolphin3.webp', 'Una bambina in acqua che si lascia dolcemente trasportare da due delfini che nuotano.', 12, 0),
(65, './assets/Africa/sharmElSheikh-egitto/activities/night-safari/images/cover.webp', 'Due persone che osservano il cielo stellato.', 13, 1),
(66, './assets/Africa/sharmElSheikh-egitto/activities/night-safari/images/night1.webp', 'Gruppo di turisti che ammira il tramonto nel deserto.', 13, 0),
(67, './assets/Africa/sharmElSheikh-egitto/activities/night-safari/images/night2.webp', 'Alcune montagne nel deserto durante la notte.', 13, 0),
(68, './assets/Africa/sharmElSheikh-egitto/activities/night-safari/images/night3.webp', 'Primo piano: cammello in controluce su una montagna nel deserto durante il tramonto, secondo piano: ', 13, 0),
(69, './assets/Africa/sharmElSheikh-egitto/activities/quad/images/cover.webp', 'Due persone su un quad seguite da una terza su un altro quad uguale.', 14, 1),
(70, './assets/Africa/sharmElSheikh-egitto/activities/quad/images/quad1.webp', 'Un cammello nel deserto con una sella ricoperta da tessuti di colori molto vivaci.', 14, 0),
(71, './assets/Africa/sharmElSheikh-egitto/activities/quad/images/quad2.webp', 'Due persone si tengono per mano mentre cavalcano due cammelli nel deserto.', 14, 0),
(72, './assets/Africa/sharmElSheikh-egitto/activities/rasMuhammad-park/images/cover.webp', 'Una ragazza che fa snorkeling sopra la barriera corallina.', 15, 1),
(73, './assets/Africa/sharmElSheikh-egitto/activities/rasMuhammad-park/images/ras1.webp', 'Foto subacquea di una razza marina di fronte ad alcune formazioni coralline.', 15, 0),
(74, './assets/Africa/sharmElSheikh-egitto/activities/rasMuhammad-park/images/ras2.webp', 'Un sub che fa snorkeling di fronte a dei coralli popolati da moltissimi pesciolini arancioni.', 15, 0),
(75, './assets/Africa/sharmElSheikh-egitto/activities/rasMuhammad-park/images/ras3.webp', 'Ingresso del parco fatto di rocce a forma di parallelepipedo posizionate in modo da formare una sort', 15, 0),
(76, './assets/Africa/sharmElSheikh-egitto/activities/tour/images/cover.webp', 'Moschea di Sharm el-Sheikh preceduta da un\'ampia piazza e circondata da negozi. La moschea alterna m', 16, 1),
(77, './assets/Africa/sharmElSheikh-egitto/activities/tour/images/tour1.webp', 'Ingresso al vecchio mercato cittadino, un posto di blocco seguito da un\'area pedonale.', 16, 0),
(78, './assets/Africa/sharmElSheikh-egitto/activities/tour/images/tour2.webp', 'Alcune spezie e altri prodotti che vengono venduti al mercato.', 16, 0),
(79, './assets/Africa/sharmElSheikh-egitto/activities/tour/images/tour3.webp', 'Piazza Soho di notte, piena di turisti con un drago costruito con strisce luminose nel mezzo.', 16, 0),
(80, './assets/Africa/windhoek-namibia/activities/city-tour/images/cover.webp', 'Vista della città dall\'alto. La Chiesa di Cristo circondata da un lato da alberi e dall\'altro da edi', 17, 1),
(81, './assets/Africa/windhoek-namibia/activities/city-tour/images/tour1.webp', 'Una turista osserva la guida mentre le illustra alcune curiosità sulla città da un punto panoramico.', 17, 0),
(82, './assets/Africa/windhoek-namibia/activities/city-tour/images/tour2.webp', 'La statua del primo presidente dell Namibia dopo l\'indipendenza con il memorial museum sullo sfondo.', 17, 0),
(83, './assets/Africa/windhoek-namibia/activities/city-tour/images/tour3.webp', 'Statua situata all\'interno dei giardini del parlamento.', 17, 0),
(84, './assets/Africa/windhoek-namibia/activities/city-tour/images/tour4.webp', 'Dei turisti osservano le favelas della città accompagnati dalla guida.', 17, 0),
(85, './assets/Africa/windhoek-namibia/activities/etosha/images/cover.webp', '3 zebre mentre si abbeverano in una pozza d\'acqua.', 18, 1),
(86, './assets/Africa/windhoek-namibia/activities/etosha/images/etosha1.webp', 'Primo piano di un leopardo.', 18, 0),
(87, './assets/Africa/windhoek-namibia/activities/etosha/images/etosha2.webp', 'Una giraffa nella savana.', 18, 0),
(88, './assets/Africa/windhoek-namibia/activities/etosha/images/etosha3.webp', 'Un elefante che attraversa un corso d\'acqua quasi in secca.', 18, 0),
(89, './assets/Africa/windhoek-namibia/activities/etosha/images/etosha4.webp', 'Un gruppo di orici nella savana.', 18, 0),
(90, './assets/Africa/windhoek-namibia/activities/etosha/images/etosha5.webp', 'Delle zebre bevono ad una pozza d\'acqua con delle antilopi sullo sfondo.', 18, 0),
(91, './assets/Africa/windhoek-namibia/activities/etosha/images/etosha6.webp', 'Un grande elefante africano in secondo piano dietro a due antilopi che scontrano le teste durante un', 18, 0),
(92, './assets/Africa/windhoek-namibia/activities/etosha/images/etosha7.webp', 'Un rinoceronte di fronte ad un corso d\'acqua.', 18, 0),
(93, './assets/Africa/windhoek-namibia/activities/etosha/images/etosha8.webp', 'Un rinoceronte nella savana.', 18, 0),
(94, './assets/Africa/windhoek-namibia/activities/himba/images/cover.webp', 'Una donna delle tribù Himba con gli abiti tradizionali.', 19, 1),
(95, './assets/Africa/windhoek-namibia/activities/himba/images/himba1.webp', 'Un gruppo di donne ed un bambino della tribù Himba con abiti tradizionali.', 19, 0),
(96, './assets/Africa/windhoek-namibia/activities/himba/images/himba2.webp', 'Opuwo, un piccolo villaggio con edifici di epoca industriale situato nel deserto.', 19, 0),
(97, './assets/Africa/windhoek-namibia/activities/himba/images/himba3.webp', 'Villaggio Himba immerso nel verde degli alberi.lt', 19, 0),
(98, './assets/Africa/windhoek-namibia/activities/okahandja/images/cover.webp', 'Statue in legno di alcuni animali tra cui elefante, rinoceronte ed antilopi.', 20, 1),
(99, './assets/Africa/windhoek-namibia/activities/okahandja/images/market1.webp', 'Statue in legno di grandi facce con fisionomie africane.', 20, 0),
(100, './assets/Africa/windhoek-namibia/activities/okahandja/images/market2.webp', 'Alte statue in legno di giraffe.', 20, 0),
(101, './assets/Africa/windhoek-namibia/activities/sossusvlei/images/cover.webp', 'Un gruppo di turisti nel deserto del Sossusvlei che cammina sullo strato superficiale di bicarbonato', 21, 1),
(102, './assets/Africa/windhoek-namibia/activities/sossusvlei/images/desert1.webp', 'Deserto del Sossusvlei con le dune rosse di sfondo e di fronte gli alberi morti uccisi dal bicarbona', 21, 0),
(103, './assets/Africa/windhoek-namibia/activities/sossusvlei/images/desert2.webp', 'Alberi morti del Sossusvlei.', 21, 0),
(104, './assets/Africa/windhoek-namibia/activities/sossusvlei/images/desert3.webp', 'Vista da una delle dune rosse del Sossusvlei, si vedono gli alberi morti sopra lo strato di bicarbon', 21, 0),
(105, './assets/Africa/windhoek-namibia/activities/sossusvlei/images/desert4.webp', 'Un\'alta duna del Sossusvlei.', 21, 0),
(106, './assets/Africa/windhoek-namibia/activities/swakopmund/images/cover.webp', 'Vista aerea della città.', 22, 1),
(107, './assets/Africa/windhoek-namibia/activities/swakopmund/images/city1.webp', 'I moli in sassi della città con la spiaggia bagnata dalla limpida acqua del mare.', 22, 0),
(108, './assets/Africa/windhoek-namibia/activities/swakopmund/images/city2.webp', 'La casa Hohenzollernahaus tutta bianca con il tetto rosso e gli infissi verdi.', 22, 0),
(109, './assets/Africa/windhoek-namibia/activities/swakopmund/images/city3.webp', 'Una strada della città circondata da edifici di stile germanico.', 22, 0),
(110, './assets/Africa/windhoek-namibia/activities/swakopmund/images/city4.webp', 'Foto di un alcuni bar che danno sulla spiaggia. Acqua del mare limpida.', 22, 0),
(111, './assets/America_del_Sud/Aruba/activities/Allevamento di farfalle/images/cover.webp', 'Farfalla della specie Vanessa cardui.', 23, 1),
(112, './assets/America_del_Sud/Aruba/activities/Allevamento di farfalle/images/butterfly_1.webp', 'farfalla azzurra della specie Morpho portis.', 23, 0),
(113, './assets/America_del_Sud/Aruba/activities/Allevamento di farfalle/images/butterfly_2.webp', 'Farfalla della specie Papilio cresphontes.', 23, 0),
(114, './assets/America_del_Sud/Aruba/activities/Allevamento di farfalle/images/butterfly_3.webp', 'Farfalla della specie Anartia jatrophae.', 23, 0),
(115, './assets/America_del_Sud/Aruba/activities/Allevamento di farfalle/images/butterfly_4.webp', 'Farfalla della specie Morpho menelaus.', 23, 0),
(116, './assets/America_del_Sud/Aruba/activities/Allevamento di farfalle/images/butterfly_5.webp', 'Farfalla della specie Dione moneta.', 23, 0),
(117, './assets/America_del_Sud/Aruba/activities/Arikok/images/cover.webp', 'Piscina naturale tra gli scogli in cui un gruppo di amici fa il bagno.', 24, 1),
(118, './assets/America_del_Sud/Aruba/activities/Arikok/images/arikok_1.webp', 'Parco nazionale di Arikok, piscina naturale tra gli scogli su cui un gruppo di amici fa il bagno.', 24, 0),
(119, './assets/America_del_Sud/Aruba/activities/Arikok/images/arikok_2.webp', 'Arikok hiking tour', 24, 0),
(120, './assets/America_del_Sud/Aruba/activities/Arikok/images/arikok_3.webp', 'Escursione a cavallo sulla spiaggia di arikok', 24, 0),
(121, './assets/America_del_Sud/Aruba/activities/Arikok/images/arikok_4.webp', 'Escursione a cavallo lungo la costa del parco nazionale di Arikok.', 24, 0),
(122, './assets/America_del_Sud/Aruba/activities/Palm Eagle Beach/images/cover.webp', 'Spiaggia di sabbia bianchissima bagnata dal mare cristallino di Palm Eagle Beach. Una palma curva a ', 25, 1),
(123, './assets/America_del_Sud/Aruba/activities/Palm Eagle Beach/images/palm_1.webp', 'Spiaggia di Palm Eagle Beach.', 25, 0),
(124, './assets/America_del_Sud/Aruba/activities/Palm Eagle Beach/images/palm_2.webp', 'Spiaggia bianca di Palm Eagle.', 25, 0),
(125, './assets/America_del_Sud/Aruba/activities/Palm Eagle Beach/images/palm_3.webp', 'Diga di sassi taglia l\'acqua cristallina della costa.', 25, 0),
(126, './assets/America_del_Sud/Aruba/activities/Palm Eagle Beach/images/palm_4.webp', 'Palm Eagle Beach vista dall\'alto in cui qualche turista si rilassa su sdraio sotto le palme.', 25, 0),
(127, './assets/America_del_Sud/Aruba/activities/Quadirikiki Cave/images/cover.webp', 'Raggi di sole che entrano dall\'alto della grotta.', 26, 1),
(128, './assets/America_del_Sud/Aruba/activities/Quadirikiki Cave/images/cave_1.webp', 'Cava illuminata', 26, 0),
(129, './assets/America_del_Sud/Aruba/activities/Quadirikiki Cave/images/cave_2.webp', 'Quadirikiki Cave', 26, 0),
(130, './assets/America_del_Sud/Aruba/activities/Quadirikiki Cave/images/cave_3.webp', 'Quadirikiki Cave con i suoi giochi di luce', 26, 0),
(131, './assets/America_del_Sud/Buenos Aires/activities/Cabildo Nacional e Casa Rosada/images/cover.webp', 'In primo piano il Cabildo Nacional, e una delle vie principali di Buenos Aires. La via ha diversi al', 27, 1),
(132, './assets/America_del_Sud/Buenos Aires/activities/Cabildo Nacional e Casa Rosada/images/cabildo_1.web', 'Cabildo di Buenos Aires, struttura storica creata nel 1176 dai coloni spagnoli', 27, 0),
(133, './assets/America_del_Sud/Buenos Aires/activities/Cabildo Nacional e Casa Rosada/images/cabildo_2.web', 'Cabildo illuminato din notte da delle luci a forma di lanterna.', 27, 0),
(134, './assets/America_del_Sud/Buenos Aires/activities/Cabildo Nacional e Casa Rosada/images/cabildo_3.web', 'Stanza interna del Cabildo in cui sono esposti vari dipinti di coloni spagnoli.', 27, 0),
(135, './assets/America_del_Sud/Buenos Aires/activities/Cabildo Nacional e Casa Rosada/images/casa_rosada.w', 'Casa Rosada di Buenos Aires, in primo piano una piccola parte della Plaza de Mayo.', 27, 0),
(136, './assets/America_del_Sud/Buenos Aires/activities/Cattedrale Metropolitana/images/cover.webp', 'Facciata della Cattedrale metropolitana di Buenos Aires in una giornata di sole. ', 28, 1),
(137, './assets/America_del_Sud/Buenos Aires/activities/Cattedrale Metropolitana/images/metropolitana_1.web', 'Cattedrale metropolitana di Buenos Aires illuminata di notte.', 28, 0),
(138, './assets/America_del_Sud/Buenos Aires/activities/Cattedrale Metropolitana/images/metropolitana_2.web', 'Interno della Cattedrale metropolitana di Buenos Aires, si nota la cupola e la illuminazione sul sof', 28, 0),
(139, './assets/America_del_Sud/Buenos Aires/activities/Cattedrale Metropolitana/images/metropolitana_3.web', 'Vista dell\'interno della Cattedrale metropolitana, l\'altare è ben illuminato e ornato di decorazioni', 28, 0),
(140, './assets/America_del_Sud/Buenos Aires/activities/Cattedrale Metropolitana/images/metropolitana_4.web', 'Vista dal basso della cupola della Cattedrale Metropolitana ornata di dipinti.', 28, 0),
(141, './assets/America_del_Sud/Buenos Aires/activities/Fiume Paraná/images/cover.webp', 'Imbarcazione turistica che naviga nel fiume Parana.', 29, 1),
(142, './assets/America_del_Sud/Buenos Aires/activities/Fiume Paraná/images/parana_1.webp', 'Fiume Parana visto dall\'alto.', 29, 0),
(143, './assets/America_del_Sud/Buenos Aires/activities/Fiume Paraná/images/parana_2.webp', 'Fiume Parana visto dall\'alto.', 29, 0),
(144, './assets/America_del_Sud/Buenos Aires/activities/Fiume Paraná/images/parana_3.webp', 'Diga sul fiume Paranà.', 29, 0),
(145, './assets/America_del_Sud/Buenos Aires/activities/Fiume Paraná/images/parana_4.webp', 'Barca turistica che naviga nel fiume paranà.', 29, 0),
(146, './assets/America_del_Sud/Buenos Aires/activities/Plaza de Mayo/images/cover.webp', 'Plaza de mayo, costituita da una statua a forma conica al centro e diverse piccole aree verdi e albe', 30, 1),
(147, './assets/America_del_Sud/Buenos Aires/activities/Plaza de Mayo/images/plaza_1.webp', 'In primo piano la scritta: \'25 MAYO 1810\' della statua al centro della plaza de mayo illuminata di n', 30, 0),
(148, './assets/America_del_Sud/Buenos Aires/activities/Plaza de Mayo/images/plaza_2.webp', 'Statua raffigurante un uomo in sella ad un cavallo.', 30, 0),
(149, './assets/America_del_Sud/Buenos Aires/activities/Plaza de Mayo/images/plaza_3.webp', 'Vista della Plaza de Mayo dall\'alto in una giornata nuvolosa.', 30, 0),
(150, './assets/America_del_Sud/Galápagos/activities/Isola Seymour/images/cover.webp', 'In foto due esemplari di \'Bobbies Pata Blu\' i cosidetti \'piedi azzurri\'.', 31, 1),
(151, './assets/America_del_Sud/Galápagos/activities/Isola Seymour/images/seymour_1.webp', 'La Fregata della Galapagos, uccello caratteristico per una grossa sacca rossa sotto il becco.', 31, 0),
(152, './assets/America_del_Sud/Galápagos/activities/Isola Seymour/images/seymour_2.webp', 'Persona che nuota nelle acque cristalline di Galapagos.', 31, 0),
(153, './assets/America_del_Sud/Galápagos/activities/Isola Seymour/images/seymour_3.webp', 'Balena che salta fuori dall\'acqua.', 31, 0),
(154, './assets/America_del_Sud/Galápagos/activities/Isola Seymour/images/seymour_4.webp', 'Pellicano bruto appoggiato su dei sassi sotto una cascata.', 31, 0),
(155, './assets/America_del_Sud/Galápagos/activities/Isola Seymour/images/seymour_5.webp', 'Piccoli granchi sugli scogli caratteristici per i loro colori rossi e a tratti verdi molto accesi.', 31, 0),
(156, './assets/America_del_Sud/Galápagos/activities/Kicker Rock/images/cover.webp', 'Kicker Rock, famosa roccia che spicca nel mare delle Galapagos.', 32, 1),
(157, './assets/America_del_Sud/Galápagos/activities/Kicker Rock/images/kicker_1.webp', 'Kicker Rock', 32, 0),
(158, './assets/America_del_Sud/Galápagos/activities/Kicker Rock/images/kicker_2.webp', 'Kicker Rock, con il sole che tramonta tra le due rocce.', 32, 0),
(159, './assets/America_del_Sud/Galápagos/activities/Kicker Rock/images/kicker_3.webp', 'Persona che sorseggia un drink mentre si rilassa in barca.', 32, 0),
(160, './assets/America_del_Sud/Galápagos/activities/Laguna de los Flamingos/images/cover.webp', '5 fenicotteri in acqua che sembrano galleggiare.', 33, 1),
(161, './assets/America_del_Sud/Galápagos/activities/Laguna de los Flamingos/images/flamingos_1.webp', '6 Fenicotteri in acqua.', 33, 0),
(162, './assets/America_del_Sud/Galápagos/activities/Laguna de los Flamingos/images/flamingos_2.webp', 'Primo piano di un fenicottero rosa.', 33, 0),
(163, './assets/America_del_Sud/Galápagos/activities/Laguna de los Flamingos/images/flamingos_3.webp', 'Fenicottero visto da vicino con il collo appoggiato sulla schiena.', 33, 0),
(164, './assets/America_del_Sud/Galápagos/activities/Parco Nazionale/images/cover.webp', 'In primo piano un iguana mentre osserva gli scogli e il mare.', 34, 1),
(165, './assets/America_del_Sud/Galápagos/activities/Parco Nazionale/images/parco_1.webp', 'Isola si Santa Cruz con un mare cristallino e una vegetazione accanato a una piccola distesa di sabb', 34, 0),
(166, './assets/America_del_Sud/Galápagos/activities/Parco Nazionale/images/parco_2.webp', 'Una foca in primo piano e nello sfondo un gruppo di foche e un mare cristallino con un imbarcazione ', 34, 0),
(167, './assets/America_del_Sud/Galápagos/activities/Parco Nazionale/images/parco_3.webp', 'In primo piano la vegetazione della vegetazione collinare di un isola delle Galapagos e un mare cris', 34, 0),
(168, './assets/America_del_Sud/Galápagos/activities/Parco Nazionale/images/parco_4.webp', 'In primo piano l\'isola di Santa Cruz e nello sfondo si possono intravedere altre isole dell\'arcipela', 34, 0),
(169, './assets/America_del_Sud/Patagonia/activities/El Chalten/images/cover.webp', 'Persona mentre ammira Laguna de los Tres con acqua cristallina e le montagne di El Chalten innevate ', 35, 1),
(170, './assets/America_del_Sud/Patagonia/activities/El Chalten/images/chalten_1.webp', 'Una coppia mentre osservano le montagne di El Chalten innevate da sopra delle rocce.', 35, 0),
(171, './assets/America_del_Sud/Patagonia/activities/El Chalten/images/chalten_2.webp', 'Gruppo di turisti che ammira la Laguna de los Tres e le montagne innevate di El Chalten.', 35, 0),
(172, './assets/America_del_Sud/Patagonia/activities/El Chalten/images/chalten_3.webp', 'Le montagne innevate di El Chalten.', 35, 0),
(173, './assets/America_del_Sud/Patagonia/activities/El Chalten/images/chalten_4.webp', 'Alberi nel bosco in Patagonia.', 35, 0),
(174, './assets/America_del_Sud/Patagonia/activities/Puerto Madryn/images/cover.webp', 'Gruppo di pinguini.', 36, 1),
(175, './assets/America_del_Sud/Patagonia/activities/Puerto Madryn/images/madryn_1.webp', 'Spiaggia con migliaia di pinguini.', 36, 0),
(176, './assets/America_del_Sud/Patagonia/activities/Puerto Madryn/images/madryn_2.webp', 'Ragazza che osserva un cucciolo di pinguino.', 36, 0),
(177, './assets/America_del_Sud/Patagonia/activities/Puerto Madryn/images/madryn_3.webp', 'Gruppo di pinguini in un terreno di sabbia e roccia.', 36, 0),
(178, './assets/America_del_Sud/Patagonia/activities/Puerto Madryn/images/madryn_4.webp', 'Centinaia di pinguini dislocati sotto una passerella e diversi turisti in spiaggia.', 36, 0),
(179, './assets/America_del_Sud/Patagonia/activities/Tour in catamarano/images/cover.webp', 'Catamarano con i turisti che ammirano i pinguini in spiaggia.', 37, 1),
(180, './assets/America_del_Sud/Patagonia/activities/Tour in catamarano/images/catamarano_1.webp', 'Catamarano con dozzine di turisti che ammirano uno scoglio con centinaia di pinguini.', 37, 0),
(181, './assets/America_del_Sud/Patagonia/activities/Tour in catamarano/images/catamarano_2.webp', 'Catamarano turistico che attraccato vicino alla spiaggia permette ai turisti di ammirare i pinguini.', 37, 0),
(182, './assets/America_del_Sud/Patagonia/activities/Tour in catamarano/images/catamarano_3.webp', 'Foche e leoni marini che riposano sugli scogli.', 37, 0),
(183, './assets/America_del_Sud/Patagonia/activities/Tour in catamarano/images/catamarano_4.webp', 'Spiaggia con migliaia di pinguini e centinaia di uccelli.', 37, 0),
(184, './assets/America_del_Sud/Patagonia/activities/Trekking sul Perito Moreno/images/cover.webp', 'Persona in mezzo alla neve dei ghiacciai.', 38, 1),
(185, './assets/America_del_Sud/Patagonia/activities/Trekking sul Perito Moreno/images/perito_moreno_1.webp', 'Coppia intenta a fare trekking sul ghiacciaio.', 38, 0),
(186, './assets/America_del_Sud/Patagonia/activities/Trekking sul Perito Moreno/images/perito_moreno_2.webp', 'Persone che ammirano il ghiacciaio perito moreno da una passerella.', 38, 0),
(187, './assets/America_del_Sud/Patagonia/activities/Trekking sul Perito Moreno/images/perito_moreno_3.webp', 'Ghiacciaio Perito Moreno visto dal livello del mare.', 38, 0),
(188, './assets/America_del_Sud/Patagonia/activities/Trekking sul Perito Moreno/images/perito_moreno_4.webp', 'Coppia di turisti sopra una roccia mentre ammirano l\'immenso ghiacciaio.', 38, 0),
(189, './assets/Asia/Bali/activities/danze-kecak/images/cover.webp', 'Nativi balinesi con i colorati vestiti tipici della tradizione.', 39, 1),
(190, './assets/Asia/Bali/activities/danze-kecak/images/dance1.webp', 'Nativi balinesi danzano di fronte a un gruppo di turisti nei loro costumi tipici su una terrazza aff', 39, 0),
(191, './assets/Asia/Bali/activities/danze-kecak/images/dance3.webp', 'Nativi balinesi intenti a danzare con le braccia in aria.', 39, 0),
(192, './assets/Asia/Bali/activities/rafting/images/cover.webp', 'Famiglia fa rafting su un gommone.', 40, 1),
(193, './assets/Asia/Bali/activities/rafting/images/quad1.webp', 'Gruppo di ragazze sui quad di ritorno dall\'escursione. ', 40, 0),
(194, './assets/Asia/Bali/activities/rafting/images/quad2.webp', 'Due ragazze ridono attraversando una zona molto fangosa del percorso in quad.', 40, 0),
(195, './assets/Asia/Bali/activities/street-food/images/cover.webp', 'Cuoco del locale cuoce dei pesci sulla griglia.', 41, 1),
(196, './assets/Asia/Bali/activities/street-food/images/food2.webp', 'Bancarella di frutta del mercato locale.', 41, 0),
(197, './assets/Asia/Bali/activities/street-food/images/food3.webp', 'Bancarella alimentare del mercato, qui si serve pollo al vapore con riso.', 41, 0),
(198, './assets/Asia/HongKong/activities/cascata/images/cover.webp', 'Una delle cascate.', 42, 1),
(199, './assets/Asia/HongKong/activities/cascata/images/cascata1.webp', 'Cascate.', 42, 0),
(200, './assets/Asia/HongKong/activities/lantau/images/cover.webp', 'Statua del grande budda e sullo sfondo le montagne di Lantau.', 43, 1),
(201, './assets/Asia/HongKong/activities/lantau/images/budda2.webp', 'Budda di Lantau, e percorso che permette di raggiungerlo.', 43, 0),
(202, './assets/Asia/HongKong/activities/lantau/images/canale.webp', 'Canale di Lantau.', 43, 0),
(203, './assets/Asia/HongKong/activities/lantau/images/tempio.webp', 'Tempio di Lantau circondato da montagne.', 43, 0),
(204, './assets/Asia/HongKong/activities/schiena-drago/images/cover.webp', 'Scorcio di montagne che rappresentano la schiena del drago.', 44, 1),
(205, './assets/Asia/HongKong/activities/schiena-drago/images/dragon.webp', 'Montagne della schiena del drago delimitate dal mare.', 44, 0),
(206, './assets/Asia/HongKong/activities/schiena-drago/images/risaie.webp', 'Distesa di risaie.', 44, 0),
(207, './assets/Asia/HongKong/activities/schiena-drago/images/risaie2.webp', 'Paese circondato da risaie.', 44, 0),
(208, './assets/Asia/HongKong/activities/tour-gastronomico/images/cover.webp', 'Piatti di ravioli e zuppe.', 45, 1),
(209, './assets/Asia/HongKong/activities/tour-gastronomico/images/food1.webp', 'Piatti di pietanze tipiche cinesi.', 45, 0),
(210, './assets/Asia/HongKong/activities/tour-gastronomico/images/food2.webp', 'Piatti e dolci tipici cinesi.', 45, 0),
(211, './assets/Asia/HongKong/activities/tour-gastronomico/images/food3.webp', 'Piatti di ravioli tipici cinesi con salsa di soia.', 45, 0),
(212, './assets/Asia/HongKong/activities/tour-privato/images/cover.webp', 'Scorcio di una strada di un\'Hong Kong notturna.', 46, 1),
(213, './assets/Asia/HongKong/activities/tour-privato/images/citta1.webp', 'Hong Kong vista dal mare.', 46, 0),
(214, './assets/Asia/HongKong/activities/tour-privato/images/citta2.webp', 'Città di Hong Kong dall\'alto.', 46, 0),
(215, './assets/Asia/Seoul/activities/gwangjang/images/cover.webp', 'Mercato in centro città. Si notano numerose bancarelle che vendono cibo.', 47, 1),
(216, './assets/Asia/Seoul/activities/gwangjang/images/market1.webp', 'Strada del mercato molto affollata.', 47, 0),
(217, './assets/Asia/Seoul/activities/gwangjang/images/market2.webp', 'Esterno dell\'edificio che ospita il mercato.', 47, 0),
(218, './assets/Asia/Seoul/activities/gyeongbokgung/images/cover.webp', 'Palazzo reale di notte, l\'illuminazione fa si che i colori dell\'edificio risaltino particolarmente.', 48, 1),
(219, './assets/Asia/Seoul/activities/gyeongbokgung/images/palace1.webp', 'Vista di giorno del palazzo reale, si notano numerose ragazze vestite in abiti tipici coreani.', 48, 0),
(220, './assets/Asia/Seoul/activities/gyeongbokgung/images/palace2.webp', 'Scorcio del palazzo e degli alberi di ciliegio.', 48, 0),
(221, './assets/Asia/Seoul/activities/lotte-world/images/cover.webp', 'Castello di Lotte, ci sono degli animatori vestiti da animaletti.', 49, 1),
(222, './assets/Asia/Seoul/activities/lotte-world/images/lotte2.webp', 'Vista dall\'alto del parco divertimenti di Lotte World illuminato con luci arcobaleno.', 49, 0),
(223, './assets/Asia/Seoul/activities/lotte-world/images/lotte4.webp', 'Artwork che rappresenta il parco divertimenti di Lotte World.', 49, 0),
(224, './assets/Asia/Seoul/activities/myeongdong/images/cover.webp', 'Vista notturna della strada principale dello shopping coreano. Si nota numerosa gente che visita i n', 50, 1),
(225, './assets/Asia/Seoul/activities/myeongdong/images/street2.webp', 'Si notano alcuni negozi e persone che passeggiano e osservano le vetrine.', 50, 0),
(226, './assets/Asia/Seoul/activities/myeongdong/images/street3.webp', 'Vista della strada principale dello shopping coreana, ci sono molte persone che passaggiano e osserv', 50, 0),
(227, './assets/Asia/Seoul/activities/namsan-tower/images/cover.webp', 'Vista della Namsan Tower al tramonto.', 51, 1),
(228, './assets/Asia/Seoul/activities/namsan-tower/images/tower1.webp', 'Vista della Namsan Tower e di un tempietto in autunno.', 51, 0),
(229, './assets/Asia/Seoul/activities/namsan-tower/images/tower2.webp', 'Cabinovia che porta alla Namsan Tower.', 51, 0),
(230, './assets/Asia/Tokyo/activities/asakusa/images/cover.webp', 'Strada che porta al Tempio Asakusa dove passeggiano in festa turisti e cittadini vestiti con abiti t', 52, 1),
(231, './assets/Asia/Tokyo/activities/asakusa/images/asak1.webp', 'Tempio di Asakusa al tramonto.', 52, 0),
(232, './assets/Asia/Tokyo/activities/asakusa/images/asak3.webp', 'Tempio di Asakusa con alberi di ciliegio.', 52, 0),
(233, './assets/Asia/Tokyo/activities/asakusa/images/shibuya1.webp', 'Vista dall\'alto delle famose strisce pedonali della stazione di Shibuya.', 52, 0),
(234, './assets/Asia/Tokyo/activities/food-tour/images/cover.webp', 'Tipico ristorante giapponese che si affaccia sulla strada, dove molti giapponesi stanno consumando i', 53, 1),
(235, './assets/Asia/Tokyo/activities/food-tour/images/foodjp1.webp', 'Bancarelle che vendono street food giapponese.', 53, 0),
(236, './assets/Asia/Tokyo/activities/food-tour/images/foodjp2.webp', 'Tipico salmone alla griglia giapponese.', 53, 0),
(237, './assets/Asia/Tokyo/activities/food-tour/images/foodjp3.webp', 'Locale giapponese dove è possibile mangiare all\'esterno.', 53, 0),
(238, './assets/Asia/Tokyo/activities/monte-fuji/images/cover.webp', 'Campagna giapponese e Monte Fuji sullo sfondo.', 54, 1),
(239, './assets/Asia/Tokyo/activities/monte-fuji/images/fuji1.webp', 'Monte Fuji al tramonto con vista su Tokyo.', 54, 0),
(240, './assets/Asia/Tokyo/activities/monte-fuji/images/fuji2.webp', 'Locali turistici sulla strada che porta al monte Fuji.', 54, 0),
(241, './assets/Asia/Tokyo/activities/monte-fuji/images/fuji3.webp', 'Monte Fuji in primavera.', 54, 0),
(242, './assets/Asia/Tokyo/activities/sky-tree/images/cover.webp', 'Vista sullo Sky Tree di sera.', 55, 1),
(243, './assets/Asia/Tokyo/activities/sky-tree/images/sky1.webp', 'Vista dall\'alto dello Sky Tree e su Tokyo di giorno.', 55, 0),
(244, './assets/Asia/Tokyo/activities/sky-tree/images/sky2 .webp', 'Tabellone informativo e interattivo all\'interno dello Sky Tree.', 55, 0),
(245, './assets/Asia/Tokyo/activities/sky-tree/images/sky3.webp', 'Corridoio con finestre di vetro dello Sky Tree che permette di vedere la città.', 55, 0),
(246, './assets/Asia/Tokyo/activities/tour-privato/images/cover.webp', 'Zona a tema anime e video games molto famosa in centro a Tokyo.', 56, 1),
(247, './assets/Asia/Tokyo/activities/tour-privato/images/cherry.webp', 'Passeggiata sul ponte che attraversa un suggestivo canale costeggiato da alberi di ciliegio in fiore', 56, 0),
(248, './assets/Asia/Tokyo/activities/tour-privato/images/shibuya1.webp', 'Stazione di Shibuya dove una grande folla sta attraversando le strisce pedonali.', 56, 0),
(249, './assets/Europa/Bruxelles/activities/Cattedrale di San Michele Arcangelo e Santa Gudula/images/cover', 'Foto della facciata principale della cattedrale illuminata con i suoi tre portali sormontati dalle r', 57, 1),
(250, './assets/Europa/Bruxelles/activities/Cattedrale di San Michele Arcangelo e Santa Gudula/images/catte', 'Interno della cattedrale con le colonne gotiche.', 57, 0),
(251, './assets/Europa/Bruxelles/activities/Cattedrale di San Michele Arcangelo e Santa Gudula/images/catte', 'Esterno della cattedrale, struttura gotica con pinnacoli e doccioni.', 57, 0),
(252, './assets/Europa/Bruxelles/activities/Cattedrale di San Michele Arcangelo e Santa Gudula/images/catte', 'Facciata principale della cattedrale con i suoi tre portali sormontati dalle relative ghimberghe.', 57, 0),
(253, './assets/Europa/Bruxelles/activities/Cattedrale di San Michele Arcangelo e Santa Gudula/images/catte', 'Facciata principale della cattedrale vista dal basso con i suoi tre portali sormontati dalle relativ', 57, 0),
(254, './assets/Europa/Bruxelles/activities/Cattedrale di San Michele Arcangelo e Santa Gudula/images/catte', 'Interno della cattedrale con vetrate decorate.', 57, 0),
(255, './assets/Europa/Bruxelles/activities/Cattedrale di San Michele Arcangelo e Santa Gudula/images/catte', 'Affresco su una delle cappelle della cattedrale.', 57, 0),
(256, './assets/Europa/Bruxelles/activities/Grand Place/images/cover.webp', 'Lussuoso edificio illuminato nella Grand Place.', 58, 1),
(257, './assets/Europa/Bruxelles/activities/Grand Place/images/grand_place_1.webp', 'Famoso tappeto di fiori che ogni due anni occupa la Grand Place con i suoi decori colorati.', 58, 0),
(258, './assets/Europa/Bruxelles/activities/Grand Place/images/grand_place_2.webp', 'La Grand Place illuminata nelle ore del crepuscolo', 58, 0),
(259, './assets/Europa/Bruxelles/activities/Grand Place/images/grand_place_3.webp', 'Maestoso tappeto di fiori che decora la Grand Place ', 58, 0),
(260, './assets/Europa/Bruxelles/activities/Grand Place/images/grand_place_4.webp', 'Complesso Mont des Arts.', 58, 0),
(261, './assets/Europa/Bruxelles/activities/Grand Place/images/grand_place_5.webp', 'Sontuosi edifici della Grand Place.', 58, 0),
(262, './assets/Europa/Bruxelles/activities/Grand Place/images/grand_place_6.webp', 'Grand Place e l\'edificio del municipio.', 58, 0),
(263, './assets/Europa/Bruxelles/activities/Musei Reali di Belle Arti/images/cover.webp', 'Musei Reali delle Belle Arti', 59, 1),
(264, './assets/Europa/Bruxelles/activities/Musei Reali di Belle Arti/images/belle_arti_1.webp', 'Stanza del museo che espone i Cochons tatoués di Wim Delvoye.', 59, 0),
(265, './assets/Europa/Bruxelles/activities/Musei Reali di Belle Arti/images/belle_arti_2.webp', 'La caduta di Icaro di Pieter Bruegel il Vecchio.', 59, 0),
(266, './assets/Europa/Bruxelles/activities/Musei Reali di Belle Arti/images/belle_arti_3.webp', 'Museo di arte e storia di Bruxelles', 59, 0),
(267, './assets/Europa/Bruxelles/activities/Musei Reali di Belle Arti/images/belle_arti_4.webp', 'Divanetto ispirato all\'Adorazione dei Magi di Rubens', 59, 0),
(268, './assets/Europa/Bruxelles/activities/Musei Reali di Belle Arti/images/belle_arti_5.webp', 'La morte di Marat Dipinto di Jacques-Louis David', 59, 0),
(269, './assets/Europa/Bruxelles/activities/Museo Magritte/images/magritte_2.webp', 'Stanza del museo Magritte.', 60, 0),
(270, './assets/Europa/Bruxelles/activities/Museo Magritte/images/cover.webp', 'Esterno dell\'edificio del Museo Magritte', 60, 1),
(271, './assets/Europa/Bruxelles/activities/Museo Magritte/images/magritte_1.webp', 'Una delle sale del museo.', 60, 0),
(272, './assets/Europa/Bruxelles/activities/Museo Magritte/images/magritte_3.webp', 'Dipinto \'Gli amanti\' di Renè Magritte.', 60, 0),
(273, './assets/Europa/Bruxelles/activities/Museo Magritte/images/magritte_4.webp', 'Dipinto \'Il figlio dell\'uomo\' di Magritte.', 60, 0),
(274, './assets/Europa/Bruxelles/activities/Museo Magritte/images/magritte_5.webp', 'Facciata esterna del museo Magritte.', 60, 0),
(275, './assets/Europa/Bruxelles/activities/Museo Magritte/images/magritte_6.webp', 'Una delle stanze della casa del pittore Renè Magritte, conservata e riarredata come appariva all\'epo', 60, 0),
(276, './assets/Europa/Ibiza/activities/Cala d\'Hort/images/cover.webp', 'Ponte che collega la spiaggia rocciosa ad uno scoglio distante pochi metri. Il mare è ricoperto da u', 61, 1),
(277, './assets/Europa/Ibiza/activities/Cala d\'Hort/images/cala_1.webp', 'Spiaggia di Cala d\'Hort. Sulla sinistra vi è la spiaggia sabbiosa con scogli solo sull\'estremità. Il', 61, 0),
(278, './assets/Europa/Ibiza/activities/Cala d\'Hort/images/cala_2.webp', 'Vista delle due isole che fronteggiano Cala d\'Hort: \'Es Vedra e Es Vedranell\', in una giornata di so', 61, 0),
(279, './assets/Europa/Ibiza/activities/Cala d\'Hort/images/cala_3.webp', 'Diverse barche a vela attraccate in mare con le vele abbassate, in sfondo le due isole che fronteggi', 61, 0),
(280, './assets/Europa/Ibiza/activities/Cova de Can Marçà/images/cover.webp', 'Stalattiti e stalagmiti formano delle decorazioni affilate illuminati da una luce bianca. Il pavimen', 62, 1),
(281, './assets/Europa/Ibiza/activities/Cova de Can Marçà/images/cova_de_can_1.webp', 'Grotta di Can Marçà con il soffitto centinaia di stalattiti e qualche stalagmite che parte dal suolo', 62, 0),
(282, './assets/Europa/Ibiza/activities/Cova de Can Marçà/images/cova_de_can_2.webp', 'Sulla destra vi sono delle scale artificiali, mentre sulla sinistra il soffitto della caverna è part', 62, 0),
(283, './assets/Europa/Ibiza/activities/Cova de Can Marçà/images/cova_de_can_3.webp', 'In primo piano diverse stalagmiti immerse nell\'acqua per diversi centimentri, mentre dal soffitto si', 62, 0),
(284, './assets/Europa/Ibiza/activities/Dalt Vila/images/cover.webp', 'Città vecchia di Ibiza, Dalt Vila, situata su una collina di fronte al mare. Nella parte bassa della', 63, 1),
(285, './assets/Europa/Ibiza/activities/Dalt Vila/images/dalt_vila_1.webp', 'Vista di tutta la città vecchia di Ibiza Dalt Vila, situata in una collina che fronteggia il mare. I', 63, 0),
(286, './assets/Europa/Ibiza/activities/Dalt Vila/images/dalt_vila_2.webp', 'Via della cittadina che costeggia diverse abitazioni tutte contraddistinte per il loro colore bianco', 63, 0),
(287, './assets/Europa/Ibiza/activities/Dalt Vila/images/dalt_vila_3.webp', 'Dalt Vila illuminata dalle luci notturne, rivela le proprie abitazioni colorate di un giallo ocra da', 63, 0),
(288, './assets/Europa/Ibiza/activities/Necropoli di Puig des Molins/images/cover.webp', 'Dama di Ibiza e altre 3 statue puniche della necropoli. ', 64, 1),
(289, './assets/Europa/Ibiza/activities/Necropoli di Puig des Molins/images/molins_1.webp', 'Nel primo piano due tombe vuote aperte, ricolme d\'acqua all\'interno della grotta della necropoli.', 64, 0),
(290, './assets/Europa/Ibiza/activities/Necropoli di Puig des Molins/images/molins_2.webp', 'Una stanza dell\'edificio della Necropoli in cui vi sono esposte dietro diverse vetrate manufatti tip', 64, 0),
(291, './assets/Europa/Ibiza/activities/Necropoli di Puig des Molins/images/molins_3.webp', 'Dietro una vetrata sono esposti manufatti come piatti e vasi illuminati da una forte luce dall\'alto.', 64, 0),
(292, './assets/Europa/Ibiza/activities/Tour in moto d\'acqua/images/cover.webp', 'Moto d\'acqua nera con dettagli gialli in acqua.', 65, 1),
(293, './assets/Europa/Ibiza/activities/Tour in moto d\'acqua/images/moto_1.webp', 'Uomo che saluta con il pollice in su sopra una moto d\'acqua nera con dettagli gialli in acqua.', 65, 0),
(294, './assets/Europa/Ibiza/activities/Tour in moto d\'acqua/images/moto_2.webp', 'Moto d\'acqua bianca con dettagli neri e gialli attraccata a riva.', 65, 0),
(295, './assets/Europa/Ibiza/activities/Tour in moto d\'acqua/images/moto_3.webp', 'Una coppia in moto d\'acqua che sfreccia ad alta velocità.', 65, 0),
(296, './assets/Europa/Nizza/activities/La Cattedrale di San Nicola/images/cover.webp', 'Vista della cattedrale da una bassa angolazione.', 66, 1),
(297, './assets/Europa/Nizza/activities/La Cattedrale di San Nicola/images/cattedrale_1.webp', 'Vista della cattedrale.', 66, 0),
(298, './assets/Europa/Nizza/activities/La Cattedrale di San Nicola/images/cattedrale_2.webp', 'Chiesa ortodossa russa di stile gotico. ', 66, 0),
(299, './assets/Europa/Nizza/activities/La Cattedrale di San Nicola/images/cattedrale_3.webp', 'Vista dalla vegetazione della cattedrale da lontano.', 66, 0),
(300, './assets/Europa/Nizza/activities/La città vecchia/images/cover.webp', 'Dipinto realistico che ritrae il fiume che attraversa la città per uno dei suoi canali. ', 67, 1),
(301, './assets/Europa/Nizza/activities/La città vecchia/images/citta_vecchia_1.webp', 'Piazza della città con diverse bancarelle e alberi che rendono la piazza viva. Attorno vi sono edifi', 67, 0),
(302, './assets/Europa/Nizza/activities/La città vecchia/images/citta_vecchia_2.webp', 'Via della città con diverse persone sedute a dei tavoli dei bar e ristoranti tipici.', 67, 0),
(303, './assets/Europa/Nizza/activities/La città vecchia/images/citta_vecchia_3.webp', 'Strada del centro cittadino provvista di binari per i tram. Vi è un particolare affollamento, anche ', 67, 0),
(304, './assets/Europa/Nizza/activities/Museo Marc Chagall/images/cover.webp', 'Stanza del museo creato in onore al pittore Marc Chagall', 68, 1),
(305, './assets/Europa/Nizza/activities/Museo Marc Chagall/images/Chagall_1.webp', 'Tre dipinti del pittore Marc Chagall esposti al museo.', 68, 0),
(306, './assets/Europa/Nizza/activities/Museo Marc Chagall/images/Chagall_2.webp', 'Due dipinti del pittore Marc Chagall esposti al museo.', 68, 0),
(307, './assets/Europa/Nizza/activities/Museo Marc Chagall/images/Chagall_3.webp', 'Le passeur de lumière', 68, 0),
(308, './assets/Europa/Nizza/activities/Museo Matisse/images/cover.webp', 'Musèe Matisse, edificio in onore a Henri Matisse, un grande artista del 900. L\'edificio presenta un ', 69, 1),
(309, './assets/Europa/Nizza/activities/Museo Matisse/images/matisse_1.webp', 'Vista del Musèe Matisse, si nota il verde del giardino, degli alberi e della siepe che si trovano a ', 69, 0),
(310, './assets/Europa/Nizza/activities/Museo Matisse/images/matisse_2.webp', 'Stanza interna del museo con due quadri che sono formati da telo marrone e diversi disegni bianchi. ', 69, 0),
(311, './assets/Europa/Nizza/activities/Museo Matisse/images/matisse_3.webp', 'Quadro raffigurante 5 uomini rossi che si tengono per mano mentre ballano in uno sfondo verde e blu.', 69, 0),
(312, './assets/Europa/Nizza/activities/Villa Massena/images/cover.webp', 'Facciata di Villa Massena, stile della belle èpoque con un giardino curato e ben diversificato con g', 70, 1),
(313, './assets/Europa/Nizza/activities/Villa Massena/images/massena_1.webp', 'Corridoio di Villa Massena in cui si nota il lusso di cui è ornamentata con colonne di marmo e mobil', 70, 0),
(314, './assets/Europa/Nizza/activities/Villa Massena/images/massena_2.webp', 'Stanza di Villa Massena arredata con diversi dipinti a muro, un tappeto di grande taglia e un lampad', 70, 0);
INSERT INTO `image_activity` (`id`, `path`, `alt`, `activity`, `is_cover`) VALUES
(315, './assets/Europa/Parigi/activities/Île de la Cité/images/cover.webp', 'Île de la Cité in una giornata di sole.', 71, 1),
(316, './assets/Europa/Parigi/activities/Île de la Cité/images/Cite_1.webp', 'Vista dal basso dell\'Île de la Cité.', 71, 0),
(317, './assets/Europa/Parigi/activities/Île de la Cité/images/Cite_2.webp', 'Fiume Senna e vista dell\'Île de la Cité.', 71, 0),
(318, './assets/Europa/Parigi/activities/Île de la Cité/images/Cite_3.webp', 'Île de la Cité in una giornata di sole, il fiume Senna presenta un acqua abbastanza limpida.', 71, 0),
(319, './assets/Europa/Parigi/activities/Montmartre/images/cover.webp', 'Vista da lontano di Montmartre in una giornata di sole. Attorno al palazzo vi è una forte vegetazion', 72, 1),
(320, './assets/Europa/Parigi/activities/Montmartre/images/montmartre_1.webp', 'Vista dal basso di Montmartre, si notano le diverse rampe di scalini per accedere alla struttura. La', 72, 0),
(321, './assets/Europa/Parigi/activities/Montmartre/images/montmartre_2.webp', 'Scalinata di una stradina del centro cittadino. La via ha diversi lampadari del 900 e una folta vege', 72, 0),
(322, './assets/Europa/Parigi/activities/Montmartre/images/montmartre_3.webp', 'Vista della cupola di Montmartre dall\'interno. ', 72, 0),
(323, './assets/Europa/Parigi/activities/Montmartre/images/montmartre_4.webp', 'Vista della città storica di Parigi, con la presenza di Montmartre sopra un\'elevazione collinare, ri', 72, 0),
(324, './assets/Europa/Parigi/activities/Museo del Louvre/images/cover.webp', 'Vista della piramide del Louvre dall\'esterno, con un riflesso sul pavimento che la fa sembrare un di', 73, 1),
(325, './assets/Europa/Parigi/activities/Museo del Louvre/images/louvre_1.webp', 'Vista dall\'esterno della piazza contenente la piramide del Louvre e di tutta la struttura maestosa.', 73, 0),
(326, './assets/Europa/Parigi/activities/Museo del Louvre/images/louvre_2.webp', 'Una sala a forma di corridoio del museo del Louvre mentre diverse persone ammirano i quadri e le ope', 73, 0),
(327, './assets/Europa/Parigi/activities/Museo del Louvre/images/louvre_3.webp', 'La Gioconda, detta anche Monna Lisa di Leonardo da Vinci', 73, 0),
(328, './assets/Europa/Parigi/activities/Museo del Louvre/images/louvre_4.webp', 'Vista dall\'interno della piramide di vetro del Louvre che scende fino a incontrare un altra piccola ', 73, 0),
(329, './assets/Europa/Parigi/activities/Museo d\'Orsay/images/cover.webp', 'Orologio del museo d\'Orsay', 74, 1),
(330, './assets/Europa/Parigi/activities/Museo d\'Orsay/images/orsay_1.webp', 'Entrata del museo d\'Orsay, si nota l\'orologio posto proprio sopra. Si nota l\'ampio spazio verso l\'al', 74, 0),
(331, './assets/Europa/Parigi/activities/Museo d\'Orsay/images/orsay_2.webp', 'Vista dell\'orologio dal suo interno. ', 74, 0),
(332, './assets/Europa/Parigi/activities/Museo d\'Orsay/images/orsay_3.webp', 'Vista del museo d\'Orsay dal fiume Senna in una giornata nuvolosa.', 74, 0),
(333, './assets/Europa/Parigi/activities/Museo d\'Orsay/images/orsay_4.webp', 'In primo piano un quadro del museo d\'Orsay raffigurante un palazzo reale e diverse persone ammassate', 74, 0),
(334, './assets/Europa/Parigi/activities/Tour Eiffel/images/cover.webp', 'Vista da lontano della Tour Eiffel e si nota in primo piano una piccola fontana con solo la testa di', 75, 1),
(335, './assets/Europa/Parigi/activities/Tour Eiffel/images/eiffel_1.webp', 'Tour Eiffel di notte illuminata dalle luci.', 75, 0),
(336, './assets/Europa/Parigi/activities/Tour Eiffel/images/eiffel_2.webp', 'Vista della Torre Eiffel dal Senna in una giornata di sole, si nota un imbarcazione turistica.', 75, 0),
(337, './assets/Europa/Parigi/activities/Tour Eiffel/images/eiffel_3.webp', 'Tour Eiffel di notte illuminata dalle luci e un faro che illumina il cielo.', 75, 0),
(338, './assets/NordAmerica/chicago-illinois/activities/art-institute/images/cover.webp', 'Ingresso dell\'Art Istitute di Chicago', 76, 1),
(339, './assets/NordAmerica/chicago-illinois/activities/art-istitute/images/art1.webp', 'La Tiffany Window altrimenti nota come Hartwell Monumental Window, composta da 48 pannelli di divers', 76, 0),
(340, './assets/NordAmerica/chicago-illinois/activities/art-istitute/images/art2.webp', 'Famoso quadro \'I nottambuli\' di Edward Hopper.', 76, 0),
(341, './assets/NordAmerica/chicago-illinois/activities/art-istitute/images/art3.webp', 'American Gothic di Grant Wood.', 76, 0),
(342, './assets/NordAmerica/chicago-illinois/activities/art-istitute/images/art4.webp', 'Edificio Modern Wing che ospita l\'Art Istitute a Chicago.', 76, 0),
(343, './assets/NordAmerica/chicago-illinois/activities/centennial-wheel/images/cover.webp', 'Centennial Wheel di Chicago.', 77, 1),
(344, './assets/NordAmerica/chicago-illinois/activities/centennial-wheel/images/wheel1.webp', 'Interno della cabina della ruota panoramica con comodi sedili in pelle.', 77, 0),
(345, './assets/NordAmerica/chicago-illinois/activities/centennial-wheel/images/wheel2.webp', 'Tettoia di entrata e uscita dalle cabine della ruota panoramica.', 77, 0),
(346, './assets/NordAmerica/chicago-illinois/activities/centennial-wheel/images/wheel3.webp', 'Interno di una delle cabine della ruota panoramica, dalle vetrate si vede il mare e il panorama di C', 77, 0),
(347, './assets/NordAmerica/chicago-illinois/activities/guided-cruise/images/cover.webp', 'Crociera turistica del fiume Chicago.', 78, 1),
(348, './assets/NordAmerica/chicago-illinois/activities/guided-cruise/images/cruise2.webp', 'Traghetto turistico sul fiume Chicago da cui osservare i grattacieli della città.', 78, 0),
(349, './assets/NordAmerica/chicago-illinois/activities/guided-cruise/images/cruise3.webp', 'Turisti osservano dal traghetto uno dei ponti aprirsi.', 78, 0),
(350, './assets/NordAmerica/chicago-illinois/activities/guided-cruise/images/cruise4.webp', 'Tribune Tower di Chicago.', 78, 0),
(351, './assets/NordAmerica/chicago-illinois/activities/guided-tour/images/cover.webp', 'La scultura Cloud Gate, comunemente nota come The Bean.', 79, 1),
(352, './assets/NordAmerica/chicago-illinois/activities/guided-tour/images/tour1.webp', 'Chicago Cultural Center', 79, 0),
(353, './assets/NordAmerica/chicago-illinois/activities/guided-tour/images/tour2.webp', 'Franklin Street Bridge di Chicago.', 79, 0),
(354, './assets/NordAmerica/chicago-illinois/activities/guided-tour/images/tour3.webp', 'Tour del cibo, tappa da Downtown Dogs.', 79, 0),
(355, './assets/NordAmerica/chicago-illinois/activities/guided-tour/images/tour4.webp', 'Riverwalk Avanue, passaggiata lungo il fiume.', 79, 0),
(356, './assets/NordAmerica/chicago-illinois/activities/panoramic-view/images/cover.webp', 'Città di Chicago vista dall\'alto, i caratteristici grattacieli tra cui spicca la torre John Hancock ', 80, 1),
(357, './assets/NordAmerica/chicago-illinois/activities/panoramic-view/images/panoramic1.webp', 'Aperitivo con vista mozzafiato sulla città al Cloud Bar, al 94° piano del 360 Chicago.', 80, 0),
(358, './assets/NordAmerica/chicago-illinois/activities/panoramic-view/images/panoramic2.webp', 'Piattaforma di vetro e acciaio che consente ai turisti coraggiosi di vedere la città da una diversa.', 80, 0),
(359, './assets/NordAmerica/chicago-illinois/activities/panoramic-view/images/panoramic3.webp', 'Metropoli di Chicago in uno scatto notturno, le strade e gli edifici della città sono illuminati a g', 80, 0),
(360, './assets/NordAmerica/chicago-illinois/activities/panoramic-view/images/panoramic4.webp', 'Moderno ed elegante Cloud Bar al 94° piano di 360 Chicago.', 80, 0),
(361, './assets/NordAmerica/losAngeles-california/activities/death-valley/images/cover.webp', 'Panoramica della Death Valley con 3 grosse formazioni rocciose nel mezzo.', 81, 1),
(362, './assets/NordAmerica/losAngeles-california/activities/death-valley/images/death-valley1.webp', 'Canyon con formazioni rocciose caratterizzate da forme dolci e curvilinee causate dall\'erosione dell', 81, 0),
(363, './assets/NordAmerica/losAngeles-california/activities/death-valley/images/death-valley2.webp', 'La strada 66 che attraversa la death valley, con il deserto alle estremità e le spoglie montagne sul', 81, 0),
(364, './assets/NordAmerica/losAngeles-california/activities/death-valley/images/death-valley3.webp', 'Un albero morto adagiato sul terreno roccioso e sabbioso della death valley.', 81, 0),
(365, './assets/NordAmerica/losAngeles-california/activities/death-valley/images/death-valley4.webp', 'Due persone che risalgono una delle dune.', 81, 0),
(366, './assets/NordAmerica/losAngeles-california/activities/death-valley/images/death-valley5.webp', 'Alba vista dalla cima di un colle della death-valley.', 81, 0),
(367, './assets/NordAmerica/losAngeles-california/activities/grand-canyon/images/cover.webp', 'Panoramica dalla cima del canyon, si vede un corso d\'acqua che lo attraversa.', 82, 1),
(368, './assets/NordAmerica/losAngeles-california/activities/grand-canyon/images/canyon1.webp', 'Panoramica dalla cima del canyon, con un corso d\'acqua che lo attraversa a valle.', 82, 0),
(369, './assets/NordAmerica/losAngeles-california/activities/grand-canyon/images/canyon4.webp', 'Vista interna da una delle gallerie del canyon, si nota la luce che entra dalle rocce erose.', 82, 0),
(370, './assets/NordAmerica/losAngeles-california/activities/grand-canyon/images/canyon2.webp', 'Panoramica dalla cima del canyon con un corso  d\'acqua che crea un anello attorno ad una delle forma', 82, 0),
(371, './assets/NordAmerica/losAngeles-california/activities/grand-canyon/images/canyon3.webp', 'Panoramica del canyon.', 82, 0),
(372, './assets/NordAmerica/losAngeles-california/activities/grand-canyon/images/canyon5.webp', 'Vista dalla cima di una delle insenatura del canyon con alcuni sempreverdi cresciuti tra le rocce.', 82, 0),
(373, './assets/NordAmerica/losAngeles-california/activities/grand-canyon/images/canyon6.webp', 'Panoramica del canyon.', 82, 0),
(374, './assets/NordAmerica/losAngeles-california/activities/las-vegas/images/cover.webp', 'Iconico cartello di benvenuto a Las Vegas di forma romboidale, seguito da alcune palme e sullo sfond', 83, 1),
(375, './assets/NordAmerica/losAngeles-california/activities/las-vegas/images/lasVegas1.webp', 'Panoramica notturna del quartiere con la replica della torre eiffel e l\'arco di trionfo, seguiti dai', 83, 0),
(376, './assets/NordAmerica/losAngeles-california/activities/las-vegas/images/lasVegas2.webp', 'Panoramica notturna della città vista da dietro il famoso hotel casinò Bellagio, si vedono le iconic', 83, 0),
(377, './assets/NordAmerica/losAngeles-california/activities/las-vegas/images/lasVegas3.webp', 'Un grande hotel casinò della città.', 83, 0),
(378, './assets/NordAmerica/losAngeles-california/activities/las-vegas/images/lasVegas4.webp', 'Il casinò hotel Ceasers Palace, set del film Una Notte Da Leoni.', 83, 0),
(379, './assets/NordAmerica/losAngeles-california/activities/madame-tussauds/images/cover.webp', 'Logo del Madame Tussauds di Hollywood.', 84, 1),
(380, './assets/NordAmerica/losAngeles-california/activities/madame-tussauds/images/tussauds1.webp', 'Statua di cera di un beduino con il cammello dietro.', 84, 0),
(381, './assets/NordAmerica/losAngeles-california/activities/madame-tussauds/images/tussauds2.webp', 'Statua di cera di Donald Trump circondato e immerso nella spazzatura.', 84, 0),
(382, './assets/NordAmerica/losAngeles-california/activities/madame-tussauds/images/tussauds3.webp', 'Ingresso del museo, è presente un bar con tavolini all\'esterno.', 84, 0),
(383, './assets/NordAmerica/losAngeles-california/activities/universal-tour/images/cover.webp', 'Statua del logo della Universal, globo terrestre con davanti la scritta Universal.', 85, 1),
(384, './assets/NordAmerica/losAngeles-california/activities/universal-tour/images/universal1.webp', 'Set di Hogwarts scuola di magia dei film di Harry Potter.', 85, 0),
(385, './assets/NordAmerica/losAngeles-california/activities/universal-tour/images/universal2.webp', 'Statue di due minion dal film Cattivissimo me intenti a farsi dispetti mentre cercano di pitturare u', 85, 0),
(386, './assets/NordAmerica/losAngeles-california/activities/universal-tour/images/universal3.webp', 'Ingresso nell\'attrazione Krustyland, ispirato all\'iconica serie I Simpson, molto affollata.', 85, 0),
(387, './assets/NordAmerica/losAngeles-california/activities/universal-tour/images/universal4.webp', 'Ingresso del parco, un icona al neon con la scritta Universal Studios.', 85, 0),
(388, './assets/NordAmerica/losAngeles-california/activities/universal-tour/images/universal5.webp', 'Grande statua del salvatore del pianeta Optimus Prime nel film Transformers.', 85, 0),
(389, './assets/NordAmerica/newYork/activities/central-park-zoo/images/cover.webp', 'Un panda rosso intento a mangiare delle foglie di bambù.', 86, 1),
(390, './assets/NordAmerica/newYork/activities/central-park-zoo/images/zoo1.webp', 'Un leopardo delle nevi che cammina su un innevato terreno roccioso.', 86, 0),
(391, './assets/NordAmerica/newYork/activities/central-park-zoo/images/zoo2.webp', 'Un colorato pappagallo Ara.', 86, 0),
(392, './assets/NordAmerica/newYork/activities/central-park-zoo/images/zoo3.webp', 'La testa di un leone marino fuoriesce dall\'acqua con aria regale.', 86, 0),
(393, './assets/NordAmerica/newYork/activities/central-park-zoo/images/zoo4.webp', 'Un orso grizzly che osserva i turisti incuriosito.', 86, 0),
(394, './assets/NordAmerica/newYork/activities/empire-state-building/images/cover.webp', 'Panorama di New York con particolare con al centro l\'empire state building.', 87, 1),
(395, './assets/NordAmerica/newYork/activities/empire-state-building/images/empire1.webp', 'Panorama notturno di New York visto dall\'Empire State Building.', 87, 0),
(396, './assets/NordAmerica/newYork/activities/empire-state-building/images/empire2.webp', 'Vista diurna su New York dall\'Empire State Building verso sud est', 87, 0),
(397, './assets/NordAmerica/newYork/activities/empire-state-building/images/empire3.webp', 'Vista diurna su New York dall\'Empire State Building verso sud ovest.', 87, 0),
(398, './assets/NordAmerica/newYork/activities/helicopter-tour/images/cover.webp', 'Elicottero in fase di atterraggio all\'eliporto', 88, 1),
(399, './assets/NordAmerica/newYork/activities/helicopter-tour/images/helicopter1.webp', 'Elicottero che sorvola Manhattan.', 88, 0),
(400, './assets/NordAmerica/newYork/activities/helicopter-tour/images/helicopter2.webp', 'Vista dall\'elicottero della città di New York.', 88, 0),
(401, './assets/NordAmerica/newYork/activities/helicopter-tour/images/helicopter3.webp', 'Vista dal sedile di pilotaggio dell\'isola di Manhattan.', 88, 0),
(402, './assets/NordAmerica/newYork/activities/helicopter-tour/images/helicopter4.webp', 'Vista dall\'elicottero su Manhattan, in particolare su Central Park  con la città che si estende oltr', 88, 0),
(403, './assets/NordAmerica/newYork/activities/moma/images/cover.webp', 'Insegna al ingresso del MoMA.', 89, 1),
(404, './assets/NordAmerica/newYork/activities/moma/images/moma1.webp', 'Una turista che osserva alcune delle opere esposte al MoMA.', 89, 0),
(405, './assets/NordAmerica/newYork/activities/moma/images/moma2.webp', 'Alcuni dei quadri esposti al MoMA l\'area è molto illuminata.', 89, 0),
(406, './assets/NordAmerica/newYork/activities/moma/images/moma3.webp', 'Alcune delle opere esposte, l\'area è ben illuminata.', 89, 0),
(407, './assets/NordAmerica/newYork/activities/moma/images/moma4.webp', 'Vista dall\'alto di una delle sale di esposizione. Sono presenti dei posti a sedere su panchine in me', 89, 0),
(408, './assets/NordAmerica/newYork/activities/natural-history-museum/images/cover.webp', 'Sala del museo con alcuni animali imbalsamati, al centro un gruppo di elefanti.', 90, 1),
(409, './assets/NordAmerica/newYork/activities/natural-history-museum/images/museum1.webp', 'Ingresso del museo dall\'esterno.', 90, 0),
(410, './assets/NordAmerica/newYork/activities/natural-history-museum/images/museum2.webp', 'Uno scheletro di dinosauro carnivoro.', 90, 0),
(411, './assets/NordAmerica/newYork/activities/natural-history-museum/images/museum3.webp', 'Stanza con alcuni scheletri di creature preistoriche, in primo piano lo scheletro di un mammut.', 90, 0),
(412, './assets/NordAmerica/newYork/activities/natural-history-museum/images/museum4.webp', 'Statua della grande balenottera azzurra che pende dal soffitto del salone di esposizione a due piani', 90, 0),
(413, './assets/NordAmerica/newYork/activities/natural-history-museum/images/museum5.webp', 'Alcuni bambini osservano la vetrina con degli orici imbalsamati.', 90, 0),
(414, './assets/NordAmerica/newYork/activities/statue-of-liberty/images/cover.webp', 'Primo piano della statua della libertà.', 91, 1),
(415, './assets/NordAmerica/newYork/activities/statue-of-liberty/images/statue1.webp', 'Foto aerea della Statua della Libertà e l\'isola su cui è costruita.', 91, 0),
(416, './assets/NordAmerica/newYork/activities/statue-of-liberty/images/statue2.webp', 'Mezzobusto della Statua della Libertà.', 91, 0),
(417, './assets/NordAmerica/newYork/activities/statue-of-liberty/images/statue3.webp', 'Isola e Statua della Libertà viste dal traghetto che naviga sull\'Hudson.', 91, 0),
(418, './assets/NordAmerica/newYork/activities/statue-of-liberty/images/statue4.webp', 'Foto aerea della Statua della LIbertà e l\'isola su cui è costruita.', 91, 0),
(419, './assets/NordAmerica/vancouver-britishColumbia/activities/aquarium/images/cover.webp', 'Alcuni turisti nel tunnel che passa sotto una delle enormi vasche dell\'acquario.', 92, 1),
(420, './assets/NordAmerica/vancouver-britishColumbia/activities/aquarium/images/aquarium1.webp', 'L\'istruttrice da ordini al delfino durante lo spettacolo sui delfini. I visitatori guardano il tutto', 92, 0),
(421, './assets/NordAmerica/vancouver-britishColumbia/activities/aquarium/images/aquarium2.webp', 'Alcune meduse.', 92, 0),
(422, './assets/NordAmerica/vancouver-britishColumbia/activities/aquarium/images/aquarium3.webp', 'Una lucertola del rettilario dell\'acquario.', 92, 0),
(423, './assets/NordAmerica/vancouver-britishColumbia/activities/aquarium/images/aquarium4.webp', 'Un pitone verde appeso ad un ramo osserva il fotografo.', 92, 0),
(424, './assets/NordAmerica/vancouver-britishColumbia/activities/aquarium/images/aquarium5.webp', 'Dei piranha.', 92, 0),
(425, './assets/NordAmerica/vancouver-britishColumbia/activities/aquarium/images/aquarium6.webp', 'Dei pinguini.', 92, 0),
(426, './assets/NordAmerica/vancouver-britishColumbia/activities/capilano-bridge/images/cover.webp', 'Alcuni turisti camminano sul ponte sospeso in mezzo alla natura circondati da una moltitudine di alb', 93, 1),
(427, './assets/NordAmerica/vancouver-britishColumbia/activities/capilano-bridge/images/capilano1.webp', 'Alcune persone camminano sul ponte sospeso tra gli alberi.', 93, 0),
(428, './assets/NordAmerica/vancouver-britishColumbia/activities/capilano-bridge/images/capilano2.webp', 'Il lungo ponte sospeso arriva quasi a raggiungere la cima di alcuni pini.', 93, 0),
(429, './assets/NordAmerica/vancouver-britishColumbia/activities/capilano-bridge/images/capilano3.webp', 'Alcuni turisti osservano il panorama appoggiati al parapetto del ponte.', 93, 0),
(430, './assets/NordAmerica/vancouver-britishColumbia/activities/guided-tour/images/cover.webp', 'Alcuni totem degli indiani d\'america immersi nella natura.', 94, 1),
(431, './assets/NordAmerica/vancouver-britishColumbia/activities/guided-tour/images/tour1.webp', 'Il lions gate bridge.', 94, 0),
(432, './assets/NordAmerica/vancouver-britishColumbia/activities/guided-tour/images/tour2.webp', 'Granville island, località per lo shopping.', 94, 0),
(433, './assets/NordAmerica/vancouver-britishColumbia/activities/guided-tour/images/tour3.webp', 'L\'ingresso per il quartiere cinese costituito da 4 colonne che sorreggono 3 tetti di architettura as', 94, 0),
(434, './assets/NordAmerica/vancouver-britishColumbia/activities/lookout/images/cover.webp', 'Il punto panoramico di Vancouver, situato sopra l\'Harbour Center.', 95, 1),
(435, './assets/NordAmerica/vancouver-britishColumbia/activities/lookout/images/lookout1.webp', 'Il punto panoramico visto dal basso.', 95, 0),
(436, './assets/NordAmerica/vancouver-britishColumbia/activities/lookout/images/lookout2.webp', 'Vista dal punto panoramico di Vancouver, al suo interno ci sono alcuni binocoli che possono essere u', 95, 0),
(437, './assets/NordAmerica/vancouver-britishColumbia/activities/seaplane-tour/images/cover.webp', 'L\'idrovolante utilizzato per il tour aereo della città.', 96, 1),
(438, './assets/NordAmerica/vancouver-britishColumbia/activities/seaplane-tour/images/seaplane1.webp', 'Vista della città dall\'aereo.', 96, 0),
(439, './assets/NordAmerica/vancouver-britishColumbia/activities/seaplane-tour/images/seaplane2.webp', 'L\'aereo atterra sul mare di con la città sullo sfondo.', 96, 0),
(440, './assets/NordAmerica/vancouver-britishColumbia/activities/seaplane-tour/images/seaplane3.webp', 'Vista della città dall\'aereo.', 96, 0),
(441, './assets/Oceania/Auckland/activities/crociera/images/cover.webp', 'Gruppo di turisti su un catamarano fotografano sorpresi una balena che nuota vicino alla loro imbarc', 97, 1),
(442, './assets/Oceania/Auckland/activities/crociera/images/auc1.webp', 'Gita turistica in catamarano.', 97, 0),
(443, './assets/Oceania/Auckland/activities/crociera/images/auc2.webp', 'Una balena salta fuori dall\'acqua proprio di fronte a un catamarano turistico lasciando a bocca aper', 97, 0),
(444, './assets/Oceania/Auckland/activities/crociera/images/auc3.webp', 'Grande nave da crociera che naviga su un mare piatto e tranquillo.', 97, 0),
(445, './assets/Oceania/Auckland/activities/ghiacciaio/images/cover.webp', 'Gruppo di 4 amici durante un escursione sul ghiacciaio.', 98, 1),
(446, './assets/Oceania/Auckland/activities/ghiacciaio/images/ice1.webp', 'Spaccatura nel ghiacciaio.', 98, 0),
(447, './assets/Oceania/Auckland/activities/ghiacciaio/images/ice2.webp', 'Il paesaggio mostra la lingua del ghiacciaio incastonata nella gola tra i due versanti della montagn', 98, 0),
(448, './assets/Oceania/Auckland/activities/ghiacciaio/images/ice3.webp', 'Qualche escursionista attraversa la lingua del ghiacciaio.', 98, 0),
(449, './assets/Oceania/Auckland/activities/hobbiville/images/cover.webp', 'Scorcio del villaggio di Hobbiville con le piccole casette scavate sotto le colline. Il laghetto in ', 99, 1),
(450, './assets/Oceania/Auckland/activities/hobbiville/images/hobbit1.webp', 'Abitazioni della cittadina di Hobbiville direttamente dal set cinematografico del Signore degli Anel', 99, 0),
(451, './assets/Oceania/Auckland/activities/hobbiville/images/hobbit2.webp', 'Primo piano di una delle abitazioni tipiche degli hobbit.', 99, 0),
(452, './assets/Oceania/Auckland/activities/hobbiville/images/hobbit3.webp', 'Abitazione del villaggio di Hobbiville sotto la luce del tramonto.', 99, 0),
(453, './assets/Oceania/Auckland/activities/tour-cantine/images/cover.webp', 'Gruppo numeroso si gode la vista e la degustazione seduti su comodi pouf sotto ombrelloni bianchi po', 100, 1),
(454, './assets/Oceania/Auckland/activities/tour-cantine/images/pic1.webp', 'Turisti degustano i vini seduti su tavoli di legno posizionati in una terrazza che da sul panorama.', 100, 0),
(455, './assets/Oceania/Auckland/activities/tour-cantine/images/pic2.webp', 'In primo piano due calici di vino e un piatto di assaggi, sullo sfondo il panorama collinare e il ma', 100, 0),
(456, './assets/Oceania/Auckland/activities/tour-cantine/images/pic3.webp', 'Floridi filari di vigne affacciate sul mare.', 100, 0),
(457, './assets/Oceania/BoraBora/activities/catamarano/images/cover.webp', 'Famiglia su catamarano durante una gita a Bora Bora.', 101, 1),
(458, './assets/Oceania/BoraBora/activities/catamarano/images/cat1.webp', 'Gruppo di amici che si gode una gita in catamarano sull\'isola di Bora Bora.', 101, 0),
(459, './assets/Oceania/BoraBora/activities/catamarano/images/cat2.webp', 'Catamarano e isola di Bora Bora durante una giornata estiva.', 101, 0),
(460, './assets/Oceania/BoraBora/activities/catamarano/images/cat3.webp', 'Catamarano e isola di Bora Bora.', 101, 0),
(461, './assets/Oceania/BoraBora/activities/picnic/images/cover.webp', 'Picnic su una barca a Bora Bora.', 102, 1),
(462, './assets/Oceania/BoraBora/activities/picnic/images/pic1.webp', 'Picnic su una barca a Bora Bora.', 102, 0),
(463, './assets/Oceania/BoraBora/activities/picnic/images/pic2.webp', 'Gruppo di amici che prepara piatti tipici di Bora Bora.', 102, 0),
(464, './assets/Oceania/BoraBora/activities/safari-snorkeling/images/cover.webp', 'Una parte dell\'immagine rappresenta il safari e l\'altra l\'attività di snorkeling.', 103, 1),
(465, './assets/Oceania/BoraBora/activities/safari-snorkeling/images/safari1.webp', 'Famiglia che si gode su una jeep una visita al safari di Bora Bora.', 103, 0),
(466, './assets/Oceania/BoraBora/activities/safari-snorkeling/images/sea1.webp', 'Bambina che osserva i pesci sott\'acqua.', 103, 0),
(467, './assets/Oceania/BoraBora/activities/safari-snorkeling/images/sea2.webp', 'Ragazzi che fanno snorkeling.', 103, 0),
(468, './assets/Oceania/BoraBora/activities/tour-barca/images/cover.webp', 'Barca a Bora Bora pronta a salpare.', 104, 1),
(469, './assets/Oceania/Fiji/activities/crociera/images/cover.webp', 'Nave diretta verso una della isole Fiji.', 105, 1),
(470, './assets/Oceania/BoraBora/activities/tour-barca/images/barca1.webp', 'Barca al tramonto sulle acque di Bora Bora.', 104, 0),
(471, './assets/Oceania/BoraBora/activities/tour-barca/images/barca2.webp', 'Vista dall\'alto di una barca e di squali.', 104, 0),
(472, './assets/Oceania/Fiji/activities/crociera/images/pic1.webp', 'Nave diretta verso una della isole Fiji.', 105, 0),
(473, './assets/Oceania/Fiji/activities/crociera/images/pic2.webp', 'Nave diretta verso una della isole Fiji.', 105, 0),
(474, './assets/Oceania/Fiji/activities/crociera/images/pic3.webp', 'Nave diretta verso una della isole Fiji.', 105, 0),
(475, './assets/Oceania/Fiji/activities/malamala/images/cover.webp', 'Nave che arriva all\'isola di Malalmala.', 106, 1),
(476, './assets/Oceania/Fiji/activities/malamala/images/mal1.webp', 'Vista dell\'isola di Malamala.', 106, 0),
(477, './assets/Oceania/Fiji/activities/malamala/images/mal2.webp', 'Vista dell\'isola di Malamala.', 106, 0),
(478, './assets/Oceania/Fiji/activities/river-tubing/images/cover.webp', 'Gruppo di persone che fa river tubing su canoe.', 107, 1),
(479, './assets/Oceania/Fiji/activities/river-tubing/images/river1.webp', 'Vista dall\'alto sul fiume su cui si svolgono le attività di river tubing.', 107, 0),
(480, './assets/Oceania/Fiji/activities/river-tubing/images/river2.webp', 'Gruppo di persone che fa river tubing.', 107, 0),
(481, './assets/Oceania/Fiji/activities/river-tubing/images/river3.webp', 'Vista del fiume e dei gommoni che usati per river tubing.', 107, 0),
(482, './assets/Oceania/Fiji/activities/snorkeling-squali/images/cover.webp', 'Squalo che nuota tra i coralli.', 108, 1),
(483, './assets/Oceania/Fiji/activities/snorkeling-squali/images/shark1.webp', 'Ragazzo che nuota con uno squalo.', 108, 0),
(484, './assets/Oceania/Fiji/activities/snorkeling-squali/images/shark2.webp', 'Gruppo di persone che nuota con gli squali.', 108, 0),
(485, './assets/Oceania/Fiji/activities/snorkeling-squali/images/shark3.webp', 'Due persone che fanno snorkeling.', 108, 0),
(486, './assets/Oceania/Sydney/activities/sea-life/images/cover.webp', 'Famiglia che osserva degli squali all\'acquario.', 109, 1),
(487, './assets/Oceania/Sydney/activities/sea-life/images/sea1.webp', 'Gruppo di turisti che fotografano una tartaruga all\'acquario.', 109, 0),
(488, './assets/Oceania/Sydney/activities/sea-life/images/sea2.webp', 'Squali e pesci nell\'acquario.', 109, 0),
(489, './assets/Oceania/Sydney/activities/sea-life/images/sea3.webp', 'Ristorante con le pareti di vetro, posizionato sotto l\'acquario.', 109, 0),
(490, './assets/Oceania/Sydney/activities/tour-elicottero/images/cover.webp', 'Elicottero che sorvola la città di Sydney.', 110, 1),
(491, './assets/Oceania/Sydney/activities/tour-elicottero/images/eli1.webp', 'Elicottero che vola sulla città di Sydney.', 110, 0),
(492, './assets/Oceania/Sydney/activities/tour-elicottero/images/eli2.webp', 'Elicottero che vola sulla città di Sydney.', 110, 0),
(493, './assets/Oceania/Sydney/activities/tour-mountain/images/cover.webp', 'Vista delle Blue Mountains dall\'alto.', 111, 1),
(494, './assets/Oceania/Sydney/activities/tour-mountain/images/pic1.webp', 'Turisti che si fanno una foto con montagne sullo sfondo.', 111, 0),
(495, './assets/Oceania/Sydney/activities/tour-mountain/images/pic2.webp', 'Cabinovia che permette di spostarsi tra le montagne.', 111, 0),
(496, './assets/Oceania/Sydney/activities/tour-mountain/images/pic3.webp', 'Terrazzo tra le montagne.', 111, 0),
(497, './assets/Oceania/Sydney/activities/zoo-taronga/images/cover.webp', 'Giraffe allo zoo di Taronga.', 112, 1),
(498, './assets/Oceania/Sydney/activities/zoo-taronga/images/zoo1.webp', 'Facciata esterna dello zoo di Taronga.', 112, 0),
(499, './assets/Oceania/Sydney/activities/zoo-taronga/images/zoo2.webp', 'Bambino che guarda un cucciolo di leone.', 112, 0),
(500, './assets/Oceania/Sydney/activities/zoo-taronga/images/zoo3.webp', 'Leone allo zoo di Taronga.', 112, 0);
...
INSERT INTO `image_airline` (`id`, `path`, `alt`, `airline`, `is_cover`) VALUES
(1, './assets/Africa/capeTown-southAfrica/airline/images/klm-logo.png', 'Scritta della KLM Royal Dutch Airlines, la scritta KLM è in grassetto maiuscolo, sopra il logo di un', '<span lang=\"en\">KLM Royal Dutch Airlines</span>', 1),
...
(4, './assets/Africa/windhoek-namibia/airline/images/lufthansa-logo.png', 'Logo Lufthansa, un uccello all\'interno di un cerchio.', 'Lufthansa', 1),
...
(8, './assets/America_del_Sud/Patagonia/airline/images/AA-logo.webp', 'America Airlines logo.', '<span lang=\"en\">America Airlines</span>', 1),
(9, './assets/Asia/Bali/airline/images/logo.png', 'Scritta Fly Emirates.', '<span lang=\"en\">Fly Emirates</span>', 1),
...
(12, './assets/Asia/Tokyo/airline/images/logo.png', 'Logo compagnia aerea, è una scritta che dice Fly Emirates.', '<span lang=\"en\">Fly Emirates</span>', 1),
...
(14, './assets/Europa/Ibiza/airline/images/ry-logo.png', 'Logo della Ryanair.', '<span lang=\"en\">Ryanair</span>', 1),
...
(20, './assets/NordAmerica/vancouver-britishColumbia/airline/images/air-canada-logo.svg', 'Logo di air canada, una foglia d\'acero rossa.', '<span lang=\"en\">Air Canada</span>', 1),
...
INSERT INTO `image_destination` (`id`, `path`, `alt`, `destination`, `is_cover`) VALUES
(1, './assets/Africa/capeTown-southAfrica/images/cover.webp', 'Cape Town illuminata dal sole con i suoi edifici che si stendono dalle montagne alla costa e lo stad', 1, 1),
(2, './assets/Africa/capeTown-southAfrica/images/cape1.webp', 'Visuale dall\'alto della città di Cape Town affacciata sul mare, sullo sfondo la montagna del Leone.', 1, 0),
(3, './assets/Africa/capeTown-southAfrica/images/cape2.webp', 'Parte costiera della città di Cape Town che si affaccia sul mare blu, dietro, le montagne.', 1, 0),
(4, './assets/Africa/capeTown-southAfrica/images/cape3.webp', 'Viale con le casette colora de di Cape Town.', 1, 0),
(5, './assets/Africa/capeTown-southAfrica/images/cape4.webp', 'L\'imponente struttura semicircolare del Green Point Stadium situato vicino alla costa.', 1, 0),
(6, './assets/Africa/capeTown-southAfrica/images/cape5.webp', 'Cape Town e la sua montagna caratteristica montagna.', 1, 0),
(7, './assets/Africa/capeTown-southAfrica/images/cape6.webp', 'Visuale dall\'alto della città di Cape Town con i suoi edifici che si stendono dalle montagne alla co', 1, 0),
(8, './assets/Africa/mwanza-tanzania/images/cover.webp', 'Foto di Mwanza vista da una delle due sponde del golfo. La città appare immersa nella natura e prese', 2, 1),
(9, './assets/Africa/mwanza-tanzania/images/lake-victoria1.webp', 'Spiaggia di Mwanza sul lago Vittoria, l\'acqua è un po\'torbida. Sono presenti alcuni alberi sulla spi', 2, 0),
(10, './assets/Africa/mwanza-tanzania/images/lake-victoria2.webp', 'Vista dall\'alto di un pezzo del lago Vittoria in cui la giungla ha creato un promontorio su di esso.', 2, 0),
(11, './assets/Africa/mwanza-tanzania/images/mwanza1.webp', 'Una roccia posta in equilibrio sopra una formazione rocciosa nel lago, attrazione turistica chiamata', 2, 0),
(12, './assets/Africa/mwanza-tanzania/images/mwanza2.webp', 'Contrasto tra i palazzi di Mwanza e la natura che circonda e avvolge la città.', 2, 0),
(13, './assets/Africa/sharmElSheikh-egitto/images/cover.webp', 'Spiaggia con sdraio in legno ed ombrelloni in vimini accessoriati con un piccolo tavolino portaogget', 3, 1),
(14, './assets/Africa/sharmElSheikh-egitto/images/sharm1.webp', 'Moschea di Sharm el-Sheikh preceduta da un\'ampia piazza e circondata da negozi. La moschea alterna m', 3, 0),
(15, './assets/Africa/sharmElSheikh-egitto/images/sharm2.webp', 'Un sub che pratica snorkeling nel Mar Rosso, sotto di lui la barriera corallina popolata da molti pe', 3, 0),
(16, './assets/Africa/sharmElSheikh-egitto/images/sharm3.webp', 'Foto subacquea del Mar Rosso raffigurante alcune formazioni coralline e dei pesci.', 3, 0),
(17, './assets/Africa/sharmElSheikh-egitto/images/sharm4.webp', 'Diverse specie di pesci colorati che nuotano sopra la barriera corallina in un\'acqua molto limpida.', 3, 0),
(18, './assets/Africa/sharmElSheikh-egitto/images/sharm5.webp', 'Foto subacquea che raffigura una formazione corallina vista dall\'alto.', 3, 0),
(19, './assets/Africa/sharmElSheikh-egitto/images/sharm6.webp', 'Una tomba egiziana nel deserto, l\'ingresso è scavato nel muro e decorato con statue di faraoni. È pr', 3, 0),
(20, './assets/Africa/sharmElSheikh-egitto/images/sharm7.webp', 'Una piazza antistante una moschea. La moschea è costruita utilizzando mattoni chiari. Si notano le u', 3, 0),
(21, './assets/Africa/windhoek-namibia/images/cover.webp', 'Sullo sfondo delle dune, precedute da una pianura desertica sulla quale si trova un\'antilope orice.', 4, 1),
(22, './assets/Africa/windhoek-namibia/images/windhoek1.webp', 'Contrasto tra i palazzi cittadini e la natura che popola la città.', 4, 0),
(23, './assets/Africa/windhoek-namibia/images/windhoek2.webp', 'Un grande palazzo situato di fronte ad una strada a due carreggiate con due corsie ciascuna ed oltre', 4, 0),
(24, './assets/Africa/windhoek-namibia/images/windhoek3.webp', 'La famosa chiesa di Cristo di Windhoek.', 4, 0),
(25, './assets/Africa/windhoek-namibia/images/windhoek4.webp', 'La città di windhoek immersa nel verde della natura.', 4, 0),
(26, './assets/Africa/windhoek-namibia/images/windhoek5.webp', 'Vista da dietro della statua di Sam Nujoma, situata vicino alla Chiesa di Cristo che fa da sfondo.', 4, 0),
(27, './assets/Africa/windhoek-namibia/images/windhoek6.webp', 'Deserto del Deadvlei con gli alberi morti uccisi dallo strato di bicarbonato di calcio che ricopre l', 4, 0),
(28, './assets/America_del_Sud/Aruba/images/cover.webp', 'Spiaggia bianca bagnata dal mare dei Caraibi.', 5, 1),
(29, './assets/America_del_Sud/Aruba/images/aruba_1.webp', 'Paradisiaca spiaggia di Eagle Beach', 5, 0),
(30, './assets/America_del_Sud/Aruba/images/aruba_2.webp', 'Tram vintage attraversa la città di Aruba.', 5, 0),
(31, './assets/America_del_Sud/Aruba/images/aruba_3.webp', 'Fenicotteri rosa nelle acque cristalline del mare.', 5, 0),
(32, './assets/America_del_Sud/Aruba/images/aruba_4.webp', 'Visuale dall\'alto della spiaggia, l\'acqua cristallina bagna la sabbia bianca', 5, 0),
(33, './assets/America_del_Sud/Aruba/images/aruba_5.webp', 'Fenicottero rosa sulla spiaggia.', 5, 0),
(34, './assets/America_del_Sud/Aruba/images/aruba_6.webp', 'Turista nuota nelle acque cristalline del mare dei Caraibi', 5, 0),
(35, './assets/America_del_Sud/Buenos Aires/images/cover.webp', 'Plaza de Mayo, in primo piano il giardino con tanto di fontana e in background il piazzo di Congress', 6, 1),
(36, './assets/America_del_Sud/Buenos Aires/images/buenos_aires_1.webp', 'Palazzo del congresso di Buenos Aires.', 6, 0),
(37, './assets/America_del_Sud/Buenos Aires/images/buenos_aires_2.webp', 'Palazzo del congresso di Buenos Aires visto dall\'alto al tramonto.', 6, 0),
(38, './assets/America_del_Sud/Buenos Aires/images/buenos_aires_3.webp', 'Vista di notte della Plaza de Mayo illuminata dalle luci notturne. Si distingue dal resto degli edif', 6, 0),
(39, './assets/America_del_Sud/Buenos Aires/images/buenos_aires_4.webp', 'In primo piano l\'Obelisco di Buenos Aires, con i fanali delle auto che creano una scia nella notte.', 6, 0),
(40, './assets/America_del_Sud/Buenos Aires/images/buenos_aires_5.webp', 'In primo piano una statua di un fiore aperto in metallo.', 6, 0),
(41, './assets/America_del_Sud/Galápagos/images/cover.webp', 'Tartaruga d\'acqua.', 7, 1),
(42, './assets/America_del_Sud/Galápagos/images/galapagos_1.webp', 'Tartaruga di terra molto grande.', 7, 0),
(43, './assets/America_del_Sud/Galápagos/images/galapagos_2.webp', 'Granchio caratteristico per il suo colore rosso e azzurro molto acceso.', 7, 0),
(44, './assets/America_del_Sud/Galápagos/images/galapagos_3.webp', 'Spiaggia scogliosa con poca spiaggia sabbiosa e acqua cristallina.', 7, 0),
(45, './assets/America_del_Sud/Galápagos/images/galapagos_4.webp', 'Iguana di colore giallo ocra sopra gli scogli.', 7, 0),
(46, './assets/America_del_Sud/Galápagos/images/galapagos_5.webp', 'Quattro tartarughe di terra molto grandi.', 7, 0),
(47, './assets/America_del_Sud/Galápagos/images/galapagos_6.webp', 'Scogli arancioni e spiaggia cristallina in un terreno collinare.', 7, 0),
(48, './assets/America_del_Sud/Patagonia/images/cover.webp', 'Vista del ghiacciaio Perito Moreno dall\'alto e dal mare cristallino che lo bagna.', 8, 1),
(49, './assets/America_del_Sud/Patagonia/images/patagonia_1.webp', 'Vista dall\'alto del ghiacciaio Perito Moreno da lontano e da vicino la fine della foresta. In lontan', 8, 0),
(50, './assets/America_del_Sud/Patagonia/images/patagonia_2.webp', 'Parte del ghiacciaio Perito Moreno che crea un ponte ad arco con il ghiaccio.', 8, 0),
(51, './assets/America_del_Sud/Patagonia/images/patagonia_3.webp', 'Parte del ghiacciaio, si immortala lo distaccamento di una parte del ghiacciaio che si riversa in ma', 8, 0),
(52, './assets/America_del_Sud/Patagonia/images/patagonia_4.webp', 'Vista da lontano e dall\'alto del ghiacciaio in una giornata di sole.', 8, 0),
(53, './assets/America_del_Sud/Patagonia/images/patagonia_5.webp', 'Tre turisti che da sopra una roccia ammira le montagne innevate.', 8, 0),
(54, './assets/Asia/Bali/images/cover.webp', 'Pura Ulun Danu Bratan tempio indù si specchia sulla riva del lago Bratan.', 9, 1),
(55, './assets/Asia/Bali/images/bali2.webp', 'Risaie di bali strutturate in terrazzamenti sulle colline.', 9, 0),
(56, './assets/Asia/Bali/images/bali3.webp', 'Costa rocciosa con montagna quasi a picco sul mare, solo una piccola lingua di sabbia consente di av', 9, 0),
(57, './assets/Asia/Bali/images/bali4.webp', 'Panorama della zona rurale con risaie, alberi e le montagne sullo sfondo.', 9, 0),
(58, './assets/Asia/Bali/images/bali5.webp', 'Monte Bromo facente parte delle Tangger mountains rimane una dei vulcani ancora attivi della zona.', 9, 0),
(59, './assets/Asia/HongKong/images/cover.webp', 'Vista dall\'alto della città di Hongkong.', 10, 1),
(60, './assets/Asia/HongKong/images/hongkong1.webp', 'Strade notturne illuminate della città di Hong Kong.', 10, 0),
(61, './assets/Asia/HongKong/images/hongkong2.webp', 'Vista della città di Hong Kong dall\'alto.', 10, 0),
(62, './assets/Asia/HongKong/images/hongkong3.webp', 'Vista dal mare della città di Hong Kong.', 10, 0),
(63, './assets/Asia/HongKong/images/hongkong4.webp', 'Strada trafficata di Hong Kong.', 10, 0),
(64, './assets/Asia/Seoul/images/cover.webp', 'Vista del palazzo che rappresenta la Seoul vecchia e sullo sfondo si scorgono i grattacieli della Se', 11, 1),
(65, './assets/Asia/Seoul/images/seoul1.webp', 'Vista dall\'alto dei palazzi della Seoul moderna di sera.', 11, 0),
(66, './assets/Asia/Seoul/images/seoul3.webp', 'Vista dei palazzi in centro a Seoul.', 11, 0),
(67, './assets/Asia/Seoul/images/seoul4.webp', 'Vista del ponte che permette di arrivare a Seoul.', 11, 0),
(68, './assets/Asia/Seoul/images/seoul5.webp', 'Strada principale di Seoul molto trafficata.', 11, 0),
(69, './assets/Asia/Tokyo/images/cover.webp', 'Vista panoramica della città di Tokyo con Sky Tree e monte Fuji sullo sfondo.', 12, 1),
(70, './assets/Asia/Tokyo/images/tokyo2.webp', 'Scorcio dei palazzi illuminati di sera in centro a Tokyo.', 12, 0),
(71, './assets/Asia/Tokyo/images/tokyo3.webp', 'Vista di Tokyo dall\'alto, si vedono il monte Fuji e numerosi grattacieli moderni.', 12, 0),
(72, './assets/Asia/Tokyo/images/tokyo4.webp', 'Vista della Tokyo più antica.', 10, 0),
(73, './assets/Asia/Tokyo/images/tokyo5.webp', 'Vista di un palazzo giapponese antico che si erge tra i giardini in fiore di Tokyo.', 12, 0),
(74, './assets/Europa/Bruxelles/images/cover.webp', 'Gran Place nelle ore notturne.', 13, 1),
(75, './assets/Europa/Bruxelles/images/bruxelles_1.webp', 'La maestosa Gran Place con i suoi lussuosi edifici e il cielo colorato dal tramonto.', 13, 0),
(76, './assets/Europa/Bruxelles/images/bruxelles_2.webp', 'La Gran Place illuminata.', 13, 0),
(77, './assets/Europa/Bruxelles/images/bruxelles_3.webp', 'La Grand Place decorata dal grande tappeto di fiori che la occupa periodicamente ogni due anni.', 13, 0),
(78, './assets/Europa/Bruxelles/images/bruxelles_4.webp', 'Parco del Cinquantenario con il famoso Arco.', 13, 0),
(79, './assets/Europa/Bruxelles/images/bruxelles_5.webp', 'Scalinata del palazzo di giustizia.', 13, 0),
(80, './assets/Europa/Bruxelles/images/bruxelles_6.webp', 'Lussuosi palazzi della Grand Place con facciate decorate con dettagli dorati.', 13, 0),
(81, './assets/Europa/Bruxelles/images/bruxelles_7.webp', 'Municipio di Bruxelles.', 13, 0),
(82, './assets/Europa/Ibiza/images/cover.webp', 'Dalt Vila, la città vecchia di Ibiza situata in collina. In primo piano vi è il porto e i diversi ya', 14, 1),
(83, './assets/Europa/Ibiza/images/ibiza_1.webp', 'In primo piano un piccolo yatch e  3 barche a vele in un acqua cristallina di una giornata di sole e', 14, 0),
(84, './assets/Europa/Ibiza/images/ibiza_2.webp', 'L\'acqua cristallina di Ibiza di una giornata di sole con diverse barche a vela ormeggiate a largo e ', 14, 0),
(85, './assets/Europa/Ibiza/images/ibiza_3.webp', 'Sulla sinistra una spiaggia di sabbia dorata con ombrelloni e lettini e scogli su una parte della ri', 14, 0),
(86, './assets/Europa/Nizza/images/cover.webp', 'Piccolo porto di nizza in cui sono ormeggiate diverse barche e yatch. Vista della città dall\'alto.', 15, 1),
(87, './assets/Europa/Nizza/images/nizza_1.webp', 'Spiaggia cristallina, si nota la grande edificazione della cittadina in riva al mare. La spiaggia è ', 15, 0),
(88, './assets/Europa/Nizza/images/nizza_2.webp', 'Porto di Nizza, ci sono molti yatch e barche turistiche. Si nota la presenza collinare su cui Nizza ', 15, 0),
(89, './assets/Europa/Nizza/images/nizza_3.webp', 'Viale in riva al mare con palme. Spiaggia sabbiosa lunga e stretta.', 15, 0),
(90, './assets/Europa/Parigi/images/cover.webp', 'Vista della Torre Eiffel da lontano, si nota la il verde attorno tra alberi e piazze. In primo piano', 16, 1),
(91, './assets/Europa/Parigi/images/parigi_1.webp', 'Champs Elysées, vista monumentale dal basso in una giornata di sole.', 16, 0),
(92, './assets/Europa/Parigi/images/parigi_2.webp', 'Ponte di Alessandro III sopra al Senna, si notano i tipici lampioni storici che lo illuminano di not', 16, 0),
(93, './assets/Europa/Parigi/images/parigi_3.webp', 'Piramide del museo del Louvre illuminato di notte. Si intravede l\'entrata principale del museo.', 16, 0),
(94, './assets/Europa/Parigi/images/parigi_4.webp', 'Vista dall\'alto di Champs Elysées, si nota che dalla piazza partono tutte le strade principali di Pa', 16, 0),
(95, './assets/Europa/Parigi/images/parigi_5.webp', 'Cattedrale di Notre Dame in una giornata di sole mentre in piazza ci sono tanti turisti.', 16, 0),
(96, './assets/NordAmerica/chicago-illinois/images/cover.webp', 'Il mare bagna la piccola porzione di spiaggia della città, sullo sfondo i grattacieli della metropol', 17, 1),
(97, './assets/NordAmerica/chicago-illinois/images/chicago1.webp', 'Il fiume Chicago attraversa la città e inerseca le sue strade e grattacieli.', 17, 0),
(98, './assets/NordAmerica/chicago-illinois/images/chicago2.webp', 'Il Cloud Gate contornato da alberi con le foglie colorate di rosso.', 17, 0),
(99, './assets/NordAmerica/chicago-illinois/images/chicago3.webp', 'Entrata esterna del famoso Chicago Theatre sulla State St.', 17, 0),
(101, './assets/NordAmerica/chicago-illinois/images/chicago4.webp', 'Foto notturna dal mare della città illuminata.', 17, 0),
(102, './assets/NordAmerica/chicago-illinois/images/chicago5.webp', 'Visuale dall\'alto della città con i caratteristici grattacieli, sullo sfondo si vede il mare.', 17, 0),
(103, './assets/NordAmerica/losAngeles-california/images/cover.webp', 'Primo piano della caratteristica scritta hollywood sulle colline di Los Angeles.', 18, 1),
(104, './assets/NordAmerica/losAngeles-california/images/losAngeles1.webp', 'Vista da distante della caratteristica scritta hollywood sulle colline di Los Angeles.', 18, 0),
(105, './assets/NordAmerica/losAngeles-california/images/losAngeles2.webp', 'Panoramica della città vista dalla cima della collina con la scritta hollywood.', 18, 0),
(106, './assets/NordAmerica/losAngeles-california/images/losAngeles3.webp', 'Alcuni grattacieli di Los Angeles.', 18, 0),
(107, './assets/NordAmerica/losAngeles-california/images/losAngeles4.webp', 'Panoramica della città di notte.', 18, 0),
(108, './assets/NordAmerica/losAngeles-california/images/losAngeles5.webp', 'Panoramica della città.', 18, 0),
(109, './assets/NordAmerica/losAngeles-california/images/losAngeles6.webp', 'Panoramica della città al tramonto con alcune palme controluce in primo piano.', 18, 0),
(110, './assets/NordAmerica/newYork/images/cover.webp', 'Panorama di New York, al centro l\'empire state building circondato dagli elevati edifici che caratte', 19, 1),
(111, './assets/NordAmerica/newYork/images/newYork1.webp', 'Strada di New York inquadrata in mezzo ad elevati edifici.', 19, 0),
(112, './assets/NordAmerica/newYork/images/newYork2.webp', 'Vista da brooklyn sul ponte di Manhattan.', 19, 0),
(113, './assets/NordAmerica/newYork/images/newYork3.webp', 'Vista sull\'isola di Manhattan.', 19, 0),
(114, './assets/NordAmerica/newYork/images/newYork4.webp', 'Vista dall\'alto di Times Square con i caratteristici pannelli pubblicitari.', 19, 0),
(115, './assets/NordAmerica/newYork/images/newYork5.webp', 'La statua della Libertà.', 19, 0),
(116, './assets/NordAmerica/newYork/images/newYork6.webp', 'Flatiron building', 19, 0),
(117, './assets/NordAmerica/vancouver-britishColumbia/images/cover.webp', 'Il porto di Vancouver seguito da imponenti palazzi.', 20, 1),
(118, './assets/NordAmerica/vancouver-britishColumbia/images/vancouver1.webp', 'Vista aerea della città, risaltano gli alti grattacieli, il mare ed il fiume che. ', 20, 0),
(119, './assets/NordAmerica/vancouver-britishColumbia/images/vancouver2.webp', 'Foto del porto seguito dai molteplici grattacieli che popolano la città.', 20, 0),
(120, './assets/NordAmerica/vancouver-britishColumbia/images/vancouver3.webp', 'Panorama aereo di Vancouver divisa dal fiume che la attraversa.', 20, 0),
(121, './assets/NordAmerica/vancouver-britishColumbia/images/vancouver4.webp', 'Punto di vista acquatico, si vedono alcuni yacht in primo piano seguii da grattacieli.', 20, 0),
(122, './assets/NordAmerica/vancouver-britishColumbia/images/vancouver5.webp', 'Alcuni grattacieli di Vancouver.', 20, 0),
(123, './assets/NordAmerica/vancouver-britishColumbia/images/vancouver6.webp', 'Panorama del porto seguito dalla città in secondo piano.', 20, 0),
(124, './assets/Oceania/Auckland/images/cover.webp', 'Porto principale di Auckland con i moli e le barche in primo piano. Sullo sfondo moderni grattacieli', 21, 1),
(125, './assets/Oceania/Auckland/images/auck1.webp', 'Vista della città e dei suoi grattacieli dall\'alto alla luce calda del tramonto, sullo sfondo il mar', 21, 0),
(126, './assets/Oceania/Auckland/images/auck2.webp', 'Canale di Auckland con edifici e grattacieli.', 21, 0),
(127, './assets/Oceania/Auckland/images/auck3.webp', 'Parte del molo di Auckland al tramonto, lussuosi edifici sulla costa sono illuminati con luci al neo', 21, 0),
(128, './assets/Oceania/BoraBora/images/cover.webp', 'Vista panoramica delle spiaggie e della montagna di Bora Bora.', 22, 1),
(129, './assets/Oceania/BoraBora/images/bora1.webp', 'Vista delle spiagge di Bora Bora.', 22, 0),
(130, './assets/Oceania/BoraBora/images/bora2.webp', 'Due ragazzi che nuotano nelle acque limpide del mare di Bora Bora.', 22, 0),
(131, './assets/Oceania/BoraBora/images/bora4.webp', 'Vista dall\'alto di Bora Bora.', 22, 0),
(132, './assets/Oceania/Fiji/images/cover.webp', 'Vista delle fiji dall\'alto.', 23, 1),
(133, './assets/Oceania/Fiji/images/fiji1.webp', 'Vista di una delle spiagge delle isole Fiji.', 23, 0),
(134, './assets/Oceania/Fiji/images/fiji2.webp', 'Vista dall\'alto delle isole Fiji.', 23, 0),
(135, './assets/Oceania/Fiji/images/fiji3.webp', 'Vista di una delle spiagge dell\'isola, ci sono delle barche che navigano in mare.', 23, 0),
(136, './assets/Oceania/Fiji/images/fiji4.webp', 'Animatori che ballano in abiti tipici.', 23, 0),
(137, './assets/Oceania/Fiji/images/fiji5.webp', 'Uno dei resort presenti sull\'isola.', 23, 0),
(138, './assets/Oceania/Sydney/images/cover.webp', 'Vista del porto di Sydney al tramonto, si scorge il ponte che porta alla città e la città stessa sul', 24, 1),
(139, './assets/Oceania/Sydney/images/sydeny.webp', 'Museo di Sydney.', 24, 0),
(140, './assets/Oceania/Sydney/images/sydeny2.webp', 'Ponte di Sydney che porta alla città.', 24, 0),
(141, './assets/Oceania/Sydney/images/sydeny4.webp', 'Vista di Sydney e del ponte che porta ad essa.', 24, 0),
(142, './assets/Oceania/Sydney/images/sydeny5.webp', 'Una delle strade dello shopping in centro città.', 24, 0);
...
INSERT INTO `image_hotel` (`id`, `path`, `alt`, `hotel`, `is_cover`) VALUES
(1, './assets/Africa/capeTown-southAfrica/hotel/images/cover.webp', 'Visuale dell\'sterno dell\'hotel, l\'edificio è bianco a 8 piani, area esterna con piccola piscina, are', 1, 1),
(2, './assets/Africa/capeTown-southAfrica/hotel/images/bedroom1.webp', 'Interno di una camera da letto matrimoniale, l\'arredamento è contemporaneo e curato, alla sinistra d', 1, 0),
(3, './assets/Africa/capeTown-southAfrica/hotel/images/bedroom2.webp', 'Salottino della camera da letto in stanza comunicante provvisto di grande vetrata, un divano, una po', 1, 0),
(4, './assets/Africa/capeTown-southAfrica/hotel/images/breakfast1.webp', 'Esempio di colazione inglese offerta dall\'hotel.Il tavolo posto nei pressi della piscina esterna mos', 1, 0),
(5, './assets/Africa/capeTown-southAfrica/hotel/images/external1.webp', 'Esterno dell\'hotel con piscina a sfioro, zona straio con ombrelloni.', 1, 0),
(6, './assets/Africa/capeTown-southAfrica/hotel/images/restaurant1.webp', 'Terrazza ristorante con vista mare, due ospiti dell\'albergo brindano seduti a tavola.', 1, 0),
(7, './assets/Africa/mwanza-tanzania/hotel/images/cover.webp', 'Esterno dell\'hotel, giardino con ristorante con vista sul lago e l\'altra sponda del golfo. Alcuni ta', 2, 1),
(8, './assets/Africa/mwanza-tanzania/hotel/images/bedroom1.webp', 'Stanza con due letti singoli provvisti di zanzariere separati da un comodino, due tavolini, una sedi', 2, 0),
(9, './assets/Africa/mwanza-tanzania/hotel/images/bedroom2.webp', 'Stanza con due letti singoli a baldacchino separati da un comodino con zanzariera, 2 cuscini per let', 2, 0),
(10, './assets/Africa/mwanza-tanzania/hotel/images/bedroom3.webp', 'Stanza con letto matrimoniale a baldacchino con zanzariera, due comodini con piccole lampade ai lati', 2, 0),
(11, './assets/Africa/mwanza-tanzania/hotel/images/external1.webp', 'Piscina dell\'hotel circondata da alcuni tavoli coperti da gazebo e piante ornamentali. L\'acqua è lim', 2, 0),
(12, './assets/Africa/mwanza-tanzania/hotel/images/external2.webp', 'Un\'altra piscina dell\'hotel con area bar al coperto, l\'acqua è limpida.', 2, 0),
(13, './assets/Africa/mwanza-tanzania/hotel/images/external3.webp', 'Vista dall\'alto dell\'hotel. La struttura con vista lago risulta immersa nella natura.', 2, 0),
(14, './assets/Africa/sharmElSheikh-egitto/hotel/images/cover.webp', 'Piazza con palme e fontane antistante l\'ingresso del resort costituito da un grande arco a tutto ses', 3, 1),
(15, './assets/Africa/sharmElSheikh-egitto/hotel/images/bedroom1.webp', 'Camera matrimoniale ben illuminata con portafinestra con vista sulla piscina. Si vedono 1 poltrona, ', 3, 0),
(16, './assets/Africa/sharmElSheikh-egitto/hotel/images/bedroom2.webp', 'Camera con 2 letti singoli separati da un comodino, 2 cuscini per letto. È presente 1 tv, 1 scrivani', 3, 0),
(17, './assets/Africa/sharmElSheikh-egitto/hotel/images/lounge1.webp', 'Lounge dell\'hotel piena di posti a sedere per mezzo di sedie poltrone o divanetti. È presente un\'are', 3, 0),
(18, './assets/Africa/sharmElSheikh-egitto/hotel/images/resort1.webp', 'Vista del resort sulla piazza d\'ingresso, ricca di palme e decorata con alcune fontane a pavimento.', 3, 0),
(19, './assets/Africa/sharmElSheikh-egitto/hotel/images/resort2.webp', 'Una piscina del resort, circondata da sdraio in legno ed ombrelloni con alcune isolette artificiali ', 3, 0),
(20, './assets/Africa/sharmElSheikh-egitto/hotel/images/resort3.webp', 'Letti a baldacchino usati come area di relax sulla spiaggia. ', 3, 0),
(21, './assets/Africa/sharmElSheikh-egitto/hotel/images/restaurant1.webp', 'Tavolo del ristorante con vista sulla piscina. Poltrone in vimini e tavolo in vetro.', 3, 0),
(22, './assets/Africa/sharmElSheikh-egitto/hotel/images/restaurant2.webp', 'Ristorante interno ci si può sedere su sedie in vimini, poltroncine oppure divanetti. Area ben illum', 3, 0),
(23, './assets/Africa/sharmElSheikh-egitto/hotel/images/spa1.webp', 'Ingresso della spa, si nota la cassa con davanti un tavolino con posti a sedere, una caraffa di acqu', 3, 0),
(24, './assets/Africa/windhoek-namibia/hotel/images/cover.webp', 'Ingresso del resort con posto di blocco.', 4, 1),
(25, './assets/Africa/windhoek-namibia/hotel/images/bedroom1.webp', 'Camera matrimoniale con due comodini ai lati del letto, due cuscini a testa, un condizionatore che p', 4, 0),
(26, './assets/Africa/windhoek-namibia/hotel/images/bedroom2.webp', 'Camera con due letti singoli separati da un comodino, sono presenti due cuscini per letto.', 4, 0),
(27, './assets/Africa/windhoek-namibia/hotel/images/dining1.webp', 'Sala con due divani e due poltrone di vimini posti attorno a dun tavolino di legno.', 4, 0),
(28, './assets/Africa/windhoek-namibia/hotel/images/external1.webp', 'Una piccola piscina posta all\'interno di un giardino, l\'acqua è limpida.', 4, 0),
(29, './assets/Africa/windhoek-namibia/hotel/images/external2.webp', 'Grande piscina attraversata da un ponte che conduce ad una piscina sopraelevata con idromassaggio. L', 4, 0),
(30, './assets/Africa/windhoek-namibia/hotel/images/external3.webp', 'Vista dall\'alto della piscina grande, ci sono sdraio con cuscini ed ombrelloni.', 4, 0),
(31, './assets/Africa/windhoek-namibia/hotel/images/kitchen1.webp', 'Cucina con microonde, bollitore, forno, frigorifero e cappa anti odori. È presente un tavolo da pran', 4, 0),
(32, './assets/Africa/windhoek-namibia/hotel/images/reception.webp', 'Reception ordinata con una caraffa di succo e alcuni bicchieri e dei fiori alle estremità del bancon', 4, 0),
(33, './assets/America_del_Sud/Aruba/hotel/images/cover.webp', 'Struttura dell\'hotel visto dall\'alto, situato in riva al mare è composto da tre edifici a 10 piani p', 5, 1),
(34, './assets/America_del_Sud/Aruba/hotel/images/biliardo.webp', 'Sala con tavolo da biliardo.', 5, 0),
(35, './assets/America_del_Sud/Aruba/hotel/images/external_1.webp', 'Visuale dall\'alto dell\'esterno dell\'hotel, si nota uno dei tre edifici, la piscina, la spiaggia subi', 5, 0),
(36, './assets/America_del_Sud/Aruba/hotel/images/food.webp', 'Sala ristorante con buffet allestito.', 5, 0),
(37, './assets/America_del_Sud/Aruba/hotel/images/hall.webp', 'Lussuosa hall dell\'hotel con pavimenti e colonne di marmo, al centro un tavolo con un vaso di fiori ', 5, 0),
(38, './assets/America_del_Sud/Aruba/hotel/images/internal_1.webp', 'Una delle stanze dell\'hotel con due letti singoli vicini, comò con tv di fronte al letto, di fianco ', 5, 0),
(39, './assets/America_del_Sud/Aruba/hotel/images/internal_2.webp', 'Camera matrimoniale con ampio letto, zona salottino adiacente separata da un basso muretto e due gra', 5, 0),
(40, './assets/America_del_Sud/Aruba/hotel/images/pool.webp', 'Grande piscina esterna dell\'hotel.', 5, 0),
(41, './assets/America_del_Sud/Buenos Aires/hotel/images/cover.webp', 'Piscina sopra il tetto dell\'hotel con 3 sdrai e delle piccole piantine a bordo piscina.', 6, 1),
(42, './assets/America_del_Sud/Buenos Aires/hotel/images/nh_1.webp', 'Buffet della colazione.', 6, 0),
(43, './assets/America_del_Sud/Buenos Aires/hotel/images/nh_2.webp', 'Entrata dell\'hotel, con gradini posti prima della porta principale con corrimano sui muri e due pian', 6, 0),
(44, './assets/America_del_Sud/Buenos Aires/hotel/images/nh_3.webp', 'Salotto principale dell\'hotel con diversi tavoli e sedie cubiche e piccoli divanetti tutti bianchi c', 6, 0),
(45, './assets/America_del_Sud/Buenos Aires/hotel/images/nh_4.webp', 'Salotto dell\'hotel provvisto di tavoli e sedie cubiche e piccoli divanetti tutti bianchi.', 6, 0),
(46, './assets/America_del_Sud/Buenos Aires/hotel/images/nh_5.webp', 'Hall dell\'hotel con tavoli, poltrone e divanetti.', 6, 0),
(47, './assets/America_del_Sud/Buenos Aires/hotel/images/nh_6.webp', 'Piscina dell\'hotel disposta sul tetto dell\'hotel.', 6, 0),
(48, './assets/America_del_Sud/Galápagos/hotel/images/cover.webp', 'Camera d\'hotel con un piccolo tavolo e due comodini ai bordi del letto con delle lampade poste sopra', 7, 1),
(49, './assets/America_del_Sud/Galápagos/hotel/images/external_1.webp', 'Terrazzo dell\'hotel vista mare con due poltrone.', 7, 0),
(50, './assets/America_del_Sud/Galápagos/hotel/images/external_2.webp', 'Bar esterno dell\'hotel con tavoli e sedie in legno', 7, 0),
(51, './assets/America_del_Sud/Galápagos/hotel/images/internal_1.webp', 'Bagno di una camera dell\'hotel.', 7, 0),
(52, './assets/America_del_Sud/Galápagos/hotel/images/internal_3.webp', 'Camera matrimoniale dell\'hotel con due comodini con delle lampade sopra posti ai bordi del letto e u', 7, 0),
(53, './assets/America_del_Sud/Galápagos/hotel/images/internal_4.webp', 'Bagno di una camera dell\'hotel con doccia in vetro e una jacuzzi raggiungibile percorrendo due gradi', 7, 0),
(54, './assets/America_del_Sud/Galápagos/hotel/images/pool.webp', 'Piscina esterna dell\'hotel a forma circolare, non sono presenti lettini.', 7, 0),
(55, './assets/America_del_Sud/Patagonia/hotel/images/cover.webp', 'Entrata dell\'hotel, la porta è raggiungibile sia da degli scalini che da una rampa.', 8, 1),
(56, './assets/America_del_Sud/Patagonia/hotel/images/external_1.webp', 'Vista dal basso della facciata dell\'hotel, si nota l\'elevata presenza di verde tra alberi e cespugli', 8, 0),
(57, './assets/America_del_Sud/Patagonia/hotel/images/external_2.webp', 'Vista della facciata dell\'hotel.', 8, 0),
(58, './assets/America_del_Sud/Patagonia/hotel/images/internal_1.webp', 'Camera matrimoniale con due comodini, un piccolo tavolino circolare con due sedie e una scrivania co', 8, 0),
(59, './assets/America_del_Sud/Patagonia/hotel/images/internal_2.webp', 'Parte di una camera d\'hotel con la zona salotto della camera, con due poltrone e un divanetto in pri', 8, 0),
(60, './assets/America_del_Sud/Patagonia/hotel/images/internal_3.webp', 'Bagno di una camera d\'hotelcon una vasca che fornisce la possibilitò di usarla come doccia.', 8, 0),
(61, './assets/America_del_Sud/Patagonia/hotel/images/internal_4.webp', 'Camera matrimoniale dell\'hotel con due comodini e un letto singolo in aggiunta, un piccolo tavolino ', 8, 0),
(62, './assets/Asia/Bali/hotel/images/cover.webp', 'Grande piscina lussuosa all\'esterno dell\'hotel, alcune aiuole con palme si trovano nell\'acqua ai bor', 9, 1),
(63, './assets/Asia/Bali/hotel/images/bedroom1.webp', 'Interno di una camera dell\'hotel, ampio spazio per gli ospiti, letto matrimoniale con panca ai piedi', 9, 0),
(64, './assets/Asia/Bali/hotel/images/bedroom2.webp', 'Zona ristorante dell\'hotel arredata in stile contemporaneo con allestimenti il legno scuro, tavoli c', 9, 0),
(65, './assets/Asia/Bali/hotel/images/external1.webp', 'Esterno dell\'hotel e della sua struttura, l\'edificio si trova sulla costa rialzata e il panorama cir', 9, 0),
(66, './assets/Asia/Bali/hotel/images/external2.webp', 'Esterno della lussuosa suite dell\'hotel situata nella piscina a sfioro.', 9, 0),
(67, './assets/Asia/Bali/hotel/images/external3.webp', 'Visuale dall\'alto dell\'hotel e della sua struttura a ferro di cavallo in cui sono disposti gli edifi', 9, 0),
(68, './assets/Asia/HongKong/hotel/images/cover.webp', 'Hotel visto dall\'esterno, precisamente una foto scattata dal mare.', 10, 1),
(69, './assets/Asia/HongKong/hotel/images/bedroom1.webp', 'Soggiorno dallo stile moderno dove si possono individuare un divano e quattro pltrone e due tavolini', 10, 0),
(70, './assets/Asia/HongKong/hotel/images/bedroom2.webp', 'Camera con vita su un palazzo, si notano dei divanetti, un tavolino e un tavolo da pranzo.', 10, 0),
(71, './assets/Asia/HongKong/hotel/images/bedroom3.webp', 'Camera da letto con vista sulla città di Hong Kong, dallo stile moderno.', 10, 0),
(72, './assets/Asia/HongKong/hotel/images/external1.webp', 'Area relax dell\'hotel, dove viene rappresentata una piscina e dei lettini.', 10, 0),
(73, './assets/Asia/HongKong/hotel/images/external2.webp', 'Parcheggio dell\'hotel.', 10, 0),
(74, './assets/Asia/HongKong/hotel/images/external3.webp', 'Vista esterna dell\'hotel, scattata dal mare.', 10, 0),
(75, './assets/Asia/Seoul/hotel/images/cover.webp', 'Esterno dell\'hotel in centro a Seoul.', 11, 1),
(76, './assets/Asia/Seoul/hotel/images/bar.webp', 'Bar dell\'hotel.', 11, 0),
(77, './assets/Asia/Seoul/hotel/images/bedroom1.webp', 'Camera dal letto doppia con vista su Seoul.', 11, 0),
(78, './assets/Asia/Seoul/hotel/images/external1.webp', 'Vista dell\'Hotel al tramonto dall\'esterno.', 11, 0),
(79, './assets/Asia/Seoul/hotel/images/external2.webp', 'Esterno dell\'hotel.', 11, 0),
(80, './assets/Asia/Seoul/hotel/images/external3.webp', 'Vista dell\'esterno dell\'hotel.', 11, 0),
(81, './assets/Asia/Seoul/hotel/images/reception.webp', 'Reception dell\'hotel.', 11, 0),
(82, './assets/Asia/Tokyo/hotel/images/cover.webp', 'Esterno dell\'hotel.', 12, 1),
(83, './assets/Asia/Tokyo/hotel/images/bar.webp', 'Bar dell\'hotel.', 12, 0),
(84, './assets/Asia/Tokyo/hotel/images/bedroom2.webp', 'Camera da letto doppia.', 12, 0),
(85, './assets/Asia/Tokyo/hotel/images/bedroom3.webp', 'Camera da letto con due letti singoli.', 12, 0),
(86, './assets/Asia/Tokyo/hotel/images/external1.webp', 'Esterno dell\'hotel illuminato di sera.', 12, 0),
(87, './assets/Asia/Tokyo/hotel/images/external2.webp', 'Parcheggio dell\'hotel.', 12, 0),
(88, './assets/Asia/Tokyo/hotel/images/external3.webp', 'Reception dell\'hotel.', 12, 0),
(89, './assets/Europa/Bruxelles/hotel/images/cover.webp', 'Ingresso dell\'hotel Hilton visto dall\'esterno con porta di vetro girevole.', 13, 1),
(90, './assets/Europa/Bruxelles/hotel/images/food.webp', 'Buffet della colazione.', 13, 0),
(91, './assets/Europa/Bruxelles/hotel/images/internal_1.webp', 'Una delle camere matrimoniali dell\'hotel, due finestre illuminano la stanza. Ai lati del letto i due', 13, 0),
(92, './assets/Europa/Bruxelles/hotel/images/internal_3.webp', 'Una delle camere doppie dell\'albergo con letto matrimoniale. Nella stanza adiscente il bagno.', 13, 0),
(93, './assets/Europa/Bruxelles/hotel/images/internal_4.webp', 'Bagno della camera, pavimenti, ripiano e muri in  marmo, ampio specchio sopra il lavabo e vasca da b', 13, 0),
(94, './assets/Europa/Bruxelles/hotel/images/kitchen.webp', 'Sala ristornate dell\'albergo arredata sui toni del nero e del legno. Numerosi tavoli sono disposti n', 13, 0),
(95, './assets/Europa/Ibiza/hotel/images/cover.webp', 'In primo piano una vasca di lusso bianca al centro della stanza avvolta da pannelli di legno su 3 la', 14, 1),
(96, './assets/Europa/Ibiza/hotel/images/external.webp', 'Salotto esterno coperto con un apertura vista mare. In questo salotto con pavimento di parquet vi è ', 14, 0),
(97, './assets/Europa/Ibiza/hotel/images/internal.webp', 'Stanza con letto matrimoniale vista mare tramite una vetrata a muro con tenda richiudibile. Paviment', 14, 0),
(98, './assets/Europa/Ibiza/hotel/images/pool.webp', 'Grande piscina caratteristica per la sua forma ondeggiante a differenza della classica forma rettang', 14, 0),
(99, './assets/Europa/Nizza/hotel/images/cover.webp', 'Lussuosa facciata esterna con l\'ingresso principale dell\'edificio.', 15, 1),
(100, './assets/Europa/Nizza/hotel/images/external_1.webp', 'Terrazza vista mare di una camera d\'hotel con tavolino e due sedie.', 15, 0),
(101, './assets/Europa/Nizza/hotel/images/hall.webp', 'Hall lussuosa dell\'hotel con al centro un tavolo in cui vi sono diversi vasi di fiori.', 15, 0),
(102, './assets/Europa/Nizza/hotel/images/hotel.webp', 'Vista strada dell\'hotel in riva al mare. Si nota l\'evelata illuminazione dell\'hotel nelle ore nottur', 15, 0),
(103, './assets/Europa/Nizza/hotel/images/internal_1.webp', 'Camera d\'hotel di lusso, con letto matrimoniale, tre poltrone disposte per la camera, un piccolo tav', 15, 0),
(104, './assets/Europa/Nizza/hotel/images/internal_2.webp', 'Bagno della camera dell\'hotel con una piccola vasca in marmo e piano in marmo con due lavandini e un', 15, 0),
(105, './assets/Europa/Parigi/hotel/images/cover.webp', 'Entrata dell\'hotel Saint Charles, la porta d\'entrata è automatica e scorrevole.', 16, 1),
(106, './assets/Europa/Parigi/hotel/images/external_1.webp', 'Vista di una camera dell\'hotel della città, con terrazzino.', 16, 0),
(107, './assets/Europa/Parigi/hotel/images/external_2.webp', 'Entrata dell\'hotel Saint Charles, non sono presenti gradini ed è presente uno scorrimano.', 16, 0),
(108, './assets/Europa/Parigi/hotel/images/internal_1.webp', 'Camera matrimoniale dell\'hotel, non ci sono tappeti, c\'è una piccola scrivania con sedia.', 16, 0),
(109, './assets/Europa/Parigi/hotel/images/internal_2.webp', 'Camera d\'hotel del Saint Charles, con una poltrona in un angolo della stanza, e due comodini a fianc', 16, 0),
(110, './assets/Europa/Parigi/hotel/images/meeting_room.webp', 'Salotto accessibile a gli ospiti dell\'hotel dove riposarsi o fare uno spuntino. Nella stanza sono pr', 16, 0),
(111, './assets/NordAmerica/chicago-illinois/hotel/images/cover.webp', 'Berkshire Room, uno dei più famosi cocktail bar di Chicago.', 17, 1),
(112, './assets/NordAmerica/chicago-illinois/hotel/images/bedroom1.webp', 'Camera doppia con 2 spaziosi letti singoli, tra i sue letti un comodino con lampada. Due sedie e un ', 17, 0),
(113, './assets/NordAmerica/chicago-illinois/hotel/images/gym1.webp', 'Paletra dell\'hotel con macchinari e sacco da boxe.', 17, 0),
(114, './assets/NordAmerica/chicago-illinois/hotel/images/lounge1.webp', 'Lounge dell\'hotel con bancone bar e divanetti.', 17, 0),
(115, './assets/NordAmerica/chicago-illinois/hotel/images/reception1.webp', 'Reception dell\'hotel con moderno graffito alla parete.', 17, 0),
(116, './assets/NordAmerica/chicago-illinois/hotel/images/toilet1.webp', 'Bagno dei una delle camere dell\'hotel con largo specchio sulla parete e vasca da bagno.', 17, 0),
(117, './assets/NordAmerica/losAngeles-california/hotel/images/cover.webp', 'Ingresso dell\'Hotel che presenta delle tende arrotolate alle estremità.', 18, 1),
(118, './assets/NordAmerica/losAngeles-california/hotel/images/bedroom1.webp', 'Camera da letto matrimoniale ben illuminata con due cuscini a testa. È presente un frigo bar ed una ', 18, 0),
(119, './assets/NordAmerica/losAngeles-california/hotel/images/reception.webp', 'Reception dell\'Hotel, design lussuoso con piante ornamentali alle estremità ed un alto vaso nel mezz', 18, 0),
(120, './assets/NordAmerica/losAngeles-california/hotel/images/toilet1.webp', 'Bagno di una stanza, campioncini di detergenti gratuiti, asciugamani forniti. C\'è uno specchio. Dava', 18, 0),
(121, './assets/NordAmerica/newYork/hotel/images/cover.webp', 'Ingresso del pod hotel.', 19, 1),
(122, './assets/NordAmerica/newYork/hotel/images/bedroom1.webp', 'Camera matrimoniale con 2 cuscini a testa, è presente una tv di fronte al letto. Di fianco ad esso u', 19, 0),
(123, './assets/NordAmerica/newYork/hotel/images/bedroom2.webp', 'Camera singola con 2 cuscini, sotto il letto spazio per la valigia. Sono presenti una finestra e un ', 19, 0),
(124, './assets/NordAmerica/newYork/hotel/images/external1.webp', 'Tetto dell\'hotel con vista sulla città. Sono presenti delle sedie in metallo. Erba sintetica al pavi', 19, 0),
(125, './assets/NordAmerica/newYork/hotel/images/reception1.webp', 'Reception dell\'hotel, area ben illuminata.', 19, 0),
(126, './assets/NordAmerica/newYork/hotel/images/toilet1.webp', 'Bagno dell\'hotel ben illuminato e pulito. Ci sono gli asciugamani e bottigliette di detergenti. Un g', 19, 0),
(127, './assets/NordAmerica/vancouver-britishColumbia/hotel/images/cover.webp', 'Ingresso dell\'hotel.', 20, 1),
(128, './assets/NordAmerica/vancouver-britishColumbia/hotel/images/bar1.webp', 'Il bar dell\'hotel con una ricca selezione di alcolici, è provvista di bancone e alte sedie, ci sono ', 20, 0),
(129, './assets/NordAmerica/vancouver-britishColumbia/hotel/images/bedroom1.webp', 'Camera matrimoniale ben illuminata con due cuscini a testa, un comodino per lato del letto. È presen', 20, 0),
(130, './assets/NordAmerica/vancouver-britishColumbia/hotel/images/gym1.webp', 'La palestra dell\'hotel, attrezzata con due tapisrulan, una panca con dei manubri, una cyclette, un\'e', 20, 0),
(131, './assets/NordAmerica/vancouver-britishColumbia/hotel/images/restaurant1.webp', 'Il ristorante dell\'hotel con grandi tavoli ed un pianoforte, aerea ben illuminata.', 20, 0),
(132, './assets/NordAmerica/vancouver-britishColumbia/hotel/images/spa1.webp', 'La vasca idromassaggio della spa, vi si accede tramite 2 scalini sulla destra.', 20, 0),
(133, './assets/NordAmerica/vancouver-britishColumbia/hotel/images/toilet1.webp', 'Bagno di una delle camere, ci sono asciugamani e bottigliette con i detergenti, la doccia è divisa t', 20, 0),
(134, './assets/Oceania/Auckland/hotel/images/cover.webp', 'Esterno dell\'hotel con piscina e sedie a sdraio sul bordo vasca. Edifici tutto intorno.', 21, 1),
(135, './assets/Oceania/Auckland/hotel/images/bedroom1.webp', 'Accogliente camera da letto matrimoniale con divano sulla parte, tappeto circolare con tavolino da c', 21, 0),
(136, './assets/Oceania/Auckland/hotel/images/bedroom2.webp', 'Luminosa camera da letto singola con vetrate lungo due pareti, a fianco al letto un tappeto con tavo', 21, 0),
(137, './assets/Oceania/Auckland/hotel/images/bedroom3.webp', 'Camera da letto singola con ampie vetrate, tappeto e tavolo da caffè e poltrona a fianco al letto e ', 21, 0),
(138, './assets/Oceania/Auckland/hotel/images/external1.webp', 'Visuale di palazzi dal terrazzino di una camera dal letto.', 21, 0),
(139, './assets/Oceania/Auckland/hotel/images/external2.webp', 'Vista della piscina dell\'hotel dall\'alto e dei palazzi circostanti.', 21, 0),
(140, './assets/Oceania/Auckland/hotel/images/external3.webp', 'Ingresso dalla strada dell\'hotel, accesso con rampa o gradini.', 21, 0),
(141, './assets/Oceania/BoraBora/hotel/images/cover.webp', 'Vista dall\'alto dell\'hotel con tutte le casette che danno direttamente sulla spiaggia.', 22, 1),
(142, './assets/Oceania/BoraBora/hotel/images/bedroom1.webp', 'Bagno di una delle stanze dell\'hotel, a lato si nota una grande vasca idromassaggio.', 22, 0),
(143, './assets/Oceania/BoraBora/hotel/images/bedroom2.webp', 'Camera matrimoniale con vista direttamente sul mare.', 22, 0),
(144, './assets/Oceania/BoraBora/hotel/images/bedroom3.webp', 'Camera matrimoniale con giardino privato.', 22, 0),
(145, './assets/Oceania/BoraBora/hotel/images/external1.webp', 'Sala da pranzo all\'aperto.', 22, 0),
(146, './assets/Oceania/BoraBora/hotel/images/external2.webp', 'Alcune delle casette disponibili per soggiornare.', 22, 0),
(147, './assets/Oceania/BoraBora/hotel/images/external3.webp', 'Alcune delle casette con cista sulla spiaggia disponibili per soggiornare.', 22, 0),
(148, './assets/Oceania/Fiji/hotel/images/cover.webp', 'Vista dall\'alto dell\'hotel con piscina e accesso diretto alla spiaggia.', 23, 1),
(149, './assets/Oceania/Fiji/hotel/images/bedroom1.webp', 'Camera doppia con bagno.', 23, 0),
(150, './assets/Oceania/Fiji/hotel/images/bedroom2.webp', 'Camera matrimoniale con vista sulla spiaggia.', 23, 0),
(151, './assets/Oceania/Fiji/hotel/images/bedroom3.webp', 'Bagno di una delle camere matrimoniali.', 23, 0),
(152, './assets/Oceania/Fiji/hotel/images/external1.webp', 'Piscina con bar.', 23, 0),
(153, './assets/Oceania/Fiji/hotel/images/external2.webp', 'Bambini che giocano in piscina.', 23, 0),
(154, './assets/Oceania/Fiji/hotel/images/external3.webp', 'Salottino all\'aperto all\'ora del tramonto.', 23, 0),
(155, './assets/Oceania/Sydney/hotel/images/cover.webp', 'Vista dall\'alto dell\'hotel in centro a Sydney.', 24, 1),
(156, './assets/Oceania/Sydney/hotel/images/bedroom1.webp', 'Salottino di una camera doppia.', 24, 0),
(157, './assets/Oceania/Sydney/hotel/images/bedroom2.webp', 'Camera matrimoniale con vista sulla città.', 24, 0),
(158, './assets/Oceania/Sydney/hotel/images/bedroom3.webp', 'Bagno di una delle camere matrimoniali.', 24, 0),
(159, './assets/Oceania/Sydney/hotel/images/external1.webp', 'Reception dell\'hotel.', 24, 0),
(160, './assets/Oceania/Sydney/hotel/images/external2.webp', 'Sala della colazione.', 24, 0),
(161, './assets/Oceania/Sydney/hotel/images/external3.webp', 'Facciata esterna dell\'hotel.', 24, 0);
...
INSERT INTO `payment_method` (`card_number`, `cvc`, `expiration`, `name`, `surname`, `username`) VALUES
('1234123412341234', '777', '2024-12-01', 'Cosimo', 'Fini', 'gue'),
('1456745698573489', '777', '2023-08-01', 'Enrico', 'Zangrando', 'noyz'),
('2345123456788901', '777', '2024-12-01', 'Cosimo', 'Fini', 'gue'),
('3454897612345678', '777', '2024-12-01', 'Cosimo', 'Fini', 'gue'),
('3456123478903456', '777', '2024-12-01', 'Cosimo', 'Fini', 'gue');
...
--
-- Struttura della tabella `purchase_activity`
--
...
(19, '2024-02-08', '2024-02-20', 3456),
(19, '2024-07-08', '2024-07-15', 3456),
...
INSERT INTO `userprofile` (`username`, `name`, `surname`, `gender`, `date_of_birth`, `pw_hash`, `email`, `numero`, `permission`) VALUES
('admin', 'Admin', 'Admin', 'M', '1999-08-02', '$2y$10$mmbkHqnvF/0j6fkd/3a5p.b25h/ER9XOkVvHkf.X94JDGvW.NHIwS', 'admin@admin.com', '9839272', 'admin'),
('gue', 'Cosimo', 'Fini', 'M', '1980-12-25', '$2y$10$z3NQ4hjIFsaCnYo/qtwX/OfQyuqV4Vt20vSWioxdn6Ze1UyEayBMO', 'fastlife@guesus.com', '827187281', 'admin'),
('noyz', 'Emanuele', 'Frasca', 'M', '1979-12-15', '$2y$10$iww9mqq9ZBNQYPdsI9kZUe1euYbKW7.2ze8CJnLwstJ1199oIq052', 'enemy@virus.com', '9281798217', 'user'),
('zan', 'Enrico', 'Zangrando', 'M', '2000-02-08', '$2y$10$QQH/Ie7BbVpLC7wcroz2Cu2uJjnUNp2x.qGSwdgRUlh8DTHDCeSUG', 'ezangri@gmail.com', '3486851731', 'user');
...
--
-- Indici per le tabelle `purchase_activity`
--
ALTER TABLE `purchase_activity`
  ADD PRIMARY KEY (`purchase`,`activity`),
  ADD KEY `activity` (`activity`);
...
--
ALTER TABLE `purchase`
  ADD CONSTRAINT `purchase_ibfk_1` FOREIGN KEY (`username`) REFERENCES `userprofile` (`username`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `purchase_ibfk_4` FOREIGN KEY (`hotel`) REFERENCES `hotel` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `purchase_ibfk_5` FOREIGN KEY (`airline`) REFERENCES `airline` (`name`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limiti per la tabella `purchase_activity`
--
ALTER TABLE `purchase_activity`
  ADD CONSTRAINT `purchase_activity_ibfk_1` FOREIGN KEY (`purchase`) REFERENCES `purchase` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `purchase_activity_ibfk_2` FOREIGN KEY (`activity`) REFERENCES `activity` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
