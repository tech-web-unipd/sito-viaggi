...
--
-- Host: 127.0.0.1
-- Creato il: Feb 01, 2023 alle 21:16
...
(10, 'Hong Kong', 'asia', 'Cina', '<p><strong>Hong Kong</strong> è una delle metropoli più ricche e caratteristiche del pianeta e ultimamente sta facendo molto parlare di sé il suo “rapporto” con la Cina continentale.</p><p>Hong Kong è la città dei contrasti: ricchezza e povertà, luce e ombra, oriente e occidente sono solo alcune delle dicotomie osservabili in ogni angolo.</p><p>Senza ombra di dubbio, i 150 anni di influenza coloniale e i 5000 anni di tradizione cinese hanno dato a questa città una <strong>personalità unica</strong>.</p>', 'city', NULL, 17),
