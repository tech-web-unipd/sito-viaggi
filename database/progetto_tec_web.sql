...
(4, '<span lang=\"en\">Windhoek</span>', 'africa', 'Namibia', '<p><strong><span lang=\"en\">Windhoek</span></strong> è la capitale della <strong>Namibia</strong>.</p><p>Questa città è molto consigliata poiché ottimo punto di partenza per affascinanti safari nel deserto della Namibia.</p>', 'safari', NULL),
